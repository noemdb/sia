...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
    <tr>
     ...
     <td width="250"><input name="btOrden" type="button" id="btOrden" value="Cambiar Orden" title="Cambiar Método de Ordenación" onclick="javascript:Camb_Orden('<?php  echo $codigo_mov; ?>','<?php  echo $orden; ?>','<?php  echo $mostrar; ?>');"></td>
