<?php include ("../class/conect.php");  include ("../class/funciones.php"); $cod_cuenta=$_POST["txtCodigo_Cuenta"];$codigo_mov=$_POST["txtcodigo_mov"]; $debito_credito=$_POST["txtDeb_Cre"]; $descripcion_a="";
