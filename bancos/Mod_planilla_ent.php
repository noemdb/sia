...
<?php  $equipo=getenv("COMPUTERNAME");  $mcod_m="BAN013".$usuario_sia.$equipo; $codigo_mov=substr($mcod_m,0,49);
...
url='Det_ent_planillas.php?tipo_planilla=<?php echo $planilla?>&plan_desde=<?php echo $pdesde?>&plan_hasta=<?php echo $phasta?>&fecha_desde=<?php echo $fdesde?>&fecha_hasta=<?php echo $fhasta?>'; document.location=url; }
...
url="Update_plan_ent.php?planilla=<?php echo $planilla?>&nro_planilla=<?php echo $nro_planilla?>&pdesde=<?php echo $pdesde?>&phasta=<?php echo $phasta?>&fdesde=<?php echo $fdesde?>&fhasta=<?php echo $fhasta?>"+"&cod_ret="+cod_ret+"&fechae="+fechae+"&deposito="+deposito+"&banco="+banco; document.location=url; }
...
var url; var r;   r=confirm("Desea Eliminar la planilla de Enterada ?");  if (r==true){r=confirm("Esta Realmente seguro en Eliminar la planilla de Enterada ?");
 if (r==true){url="Delete_plan_ent.php?planilla=<?php echo $planilla?>&nro_planilla=<?php echo $nro_planilla?>&pdesde=<?php echo $pdesde?>&phasta=<?php echo $phasta?>&fdesde=<?php echo $fdesde?>&fhasta=<?php echo $fhasta?>"; document.location=url; } } }
function revisar(){
...
var Valido=true;
   ...
   if(f.txtnro_planilla.value==""){alert("N�mero de Planilla no puede estar Vacio"); return false; }
    ...
    <tr>
      <td><table width="770" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="758" border="0">
            <tr>
              ...
              <td width="35"><span class="Estilo5"> <input class="Estilo10" name="txtplanilla" type="text" id="txtplanilla" value="<?php  echo $planilla ?>"  size="2" maxlength="2" readonly>  </span></td>
              <td width="554"><span class="Estilo5"> <input class="Estilo10" name="txtdescripcion" type="text" id="txtdescripcion" size="80" value="<?php  echo $descripcion ?>" readonly></span></td>
        ...
        <tr>
          <td><table width="758" border="0">
            <tr>
              ...
              <td width="343"><span class="Estilo5"> <input class="Estilo10" name="txtnro_planilla" type="text" id="txtnro_planilla" size="10" maxlength="8"  readonly value="<?php  echo $nro_planilla ?>"> </span></td>
              <td width="143"><span class="Estilo5">FECHA DE EMISION: </span></td>
              <td width="122"><span class="Estilo5"><input class="Estilo10" name="txtfecha" type="text"  id="txtfecha"  value="<?php echo $fecha?>" size="12" maxlength="10" readonly></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="756" border="0">
            <tr>
              ...
              <td width="76"><span class="Estilo5">
                <input class="Estilo10" name="txttasa" type="text" id="txttasa" size="6" maxlength="6" align="right" readonly value="<?php  echo $tasa ?>">
              </span></td>
              <td width="110"><span class="Estilo5">MONTO OBJETO </span>:</td>
              <td width="214"><span class="Estilo5">
                <input class="Estilo10" name="txtmonto_objeto" type="text" id="txtmonto_objeto" size="25" align="right" maxlength="22" readonly value="<?php  echo $monto_o ?>">
              </span></td>
              <td width="82"><span class="Estilo5">RETENCI&Oacute;N:</span></td>
              <td width="189"><span class="Estilo5">
                <input class="Estilo10" name="txtmonto_retencion" type="text" id="txtmonto_retencion2" size="25" align="right" maxlength="22" readonly value="<?php  echo $monto_r ?>">
              </span></td>
            </tr>
          </table></td>
        </tr>
          ...
          <td><table width="764" >
            <tr>
              ...
              <td width="102"><span class="Estilo5">
                <input class="Estilo10" name="txttipo_documento2" type="text" id="txttipo_documento2" size="12" maxlength="20"  readonly value="<?php  echo $tipo_documento ?>">
              </span></td>
              <td width="124"><span class="Estilo5">NRO. DOCUMENTO: </span></td>
              <td width="145"><span class="Estilo5">
                <input class="Estilo10" name="txtnro_documento2" type="text" id="txtnro_documento2" size="15" maxlength="50"  readonly value="<?php  echo $nro_documento ?>">
              </span></td>
              <td width="107"><span class="Estilo5">NRO. CONTROL: </span></td>
              <td width="128"><span class="Estilo5">
                <input class="Estilo10" name="txtnro_con_factura2" type="text" id="txtnro_con_factura2" size="15" maxlength="20"  readonly value="<?php  echo $nro_con_factura ?>">
              </span></td>
            </tr>
          </table></td>
        </tr>
          ...
          <td><table width="756" border="0">
            <tr>
              <td width="82"><span class="Estilo5">CEDULA/RIF :</span></td>
                            <td width="101"><span class="Estilo5"> <input class="Estilo10" name="txtced_rif" type="text"  id="txtced_rif"  value="<?php echo $ced_rif?>" size="12" maxlength="12" readonly> </span> </td>
                 <td width="559"><span class="Estilo5"><input class="Estilo10" name="txtnombre_benef" type="text" id="txtnombre_benef"  value="<?php echo $nombre_benef?>" size="85" maxlength="85" readonly> </span></td>
        ...
        <tr>
          <td><table width="769" >
            <tr>
              ...
              <td width="80"><span class="Estilo5"><input class="Estilo10" name="txtcod_ret" type="text" id="txtcod_ret" size="3" maxlength="3"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $cod_retencion ?>"> </span></td>
              <td width="118"><span class="Estilo5">FECHA ENTERADO: </span></td>
              <td width="161"><span class="Estilo5"><input class="Estilo10" name="txtfecha_ent" type="text" id="txtfecha_ent" size="10" maxlength="10" onFocus="encender(this)" onBlur="apagar(this)"  value="<?php  echo $fecha_ent ?>"> </span></td>
              <td width="117"><span class="Estilo5">NRO. DEPOSITO: </span></td>
             <td width="115"><span class="Estilo5"><input class="Estilo10" name="txtnro_deposito" type="text" id="txtnro_deposito" size="12" maxlength="12"  onFocus="encender(this)" onBlur="apagar(this)"  value="<?php  echo $deposito ?>"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="756" border="0">
            <tr>
              ...
              <td width="594"><span class="Estilo5"><input class="Estilo10" name="txtnomb_banco" type="text" id="txtnomb_banco" size="90" maxlength="90"  onFocus="encender(this)" onBlur="apagar(this)"  onchange="chequea_cod_ret(this.form);" value="<?php echo $nombre_b;?>" >  </span> </td>
             </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <table width="699" align="center">
          <tr>
            <td width="50"><input name="txtpdesde" type="hidden" id="txtpdesde" value="<?php echo $pdesde?>"></td>
            <td width="50"><input name="txtphasta" type="hidden" id="txtphasta" value="<?php echo $phasta?>"></td>
            ...
            <td width="50"><input name="txtfdesde" type="hidden" id="txtfdesde" value="<?php echo $fdesde?>"></td>
             <td width="50"><input name="txtfhasta" type="hidden" id="txtfhasta" value="<?php echo $fhasta?>"></td>
          </tr>
        </table> </td>
    </tr>
  </table>
