...
if($tipo_formato=="EXCEL"){
	...
	?><table border="0" cellspacing='0' cellpadding='0' align="left"><?php 	}else{	$tabla="<table>";}
...
if($tipo_formato=="EXCEL"){ 
?><tr>
             <td width="30" align="left"><?php  echo $m; ?></td>
             <td width="120" align="left"><?php  echo $ced_rif; ?></td>
             <td width="150" align="left"><?php  echo $nro_doc; ?></td>
             <td width="150" align="left"><?php  echo $nro_con_doc; ?></td>
			 <td width="120" align="left"><?php  echo $fechae; ?></td>
             <td width="50" align="left"><?php  echo $tipo_doc; ?></td>
			 <td width="120" align="right" style="mso-number-format:'0.00';"><?php  echo $montoo; ?></td>
			 <td width="120" align="right" style="mso-number-format:'0.00';"><?php  echo $tasa; ?></td>
 </tr> <?php 
}
...
pg_close($conn);
if($tipo_formato=="EXCEL"){?></table><?php }else{$tabla.="</table>";echo $tabla;}
?>
