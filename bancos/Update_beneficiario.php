...
if (pg_last_error($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('CÉDULA/RIF DE BENEFICIARIO NO EXISTE'); </script> <?php }
     ...
     if (!$resultado){ ?> <script language="JavaScript"> muestra('<?php  echo $error; ?>'); </script> <?php }
      else{?><script language="JavaScript">muestra('MODIFICO EXITOSAMENTE');</script><?php  $error=0;         $desc_doc="CEDULA/RIF:".$ced_rif.",  NOMBRE BENEFICIARIO:".$nom_ant;
...
pg_close($conn);
if ($error==0){?><script language="JavaScript">document.location ='Mod_beneficiario.php?Gced_rif=<?php echo $ced_rif?>';</script> <?php }
