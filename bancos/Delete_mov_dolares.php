<?php include ("../class/conect.php");  include ("../class/funciones.php");  include ("../class/configura.inc"); $equipo=getenv("COMPUTERNAME"); $mcod_m="BAN044".$usuario_sia.$equipo; $codigo_mov=substr($mcod_m,0,49);
...
if (pg_last_error($conn)) { ?> <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1; echo $sSQL; ?><script language="JavaScript">  muestra('MOVIMIENTO EN DOLARES NO EXISTE');  </script><?php }
