...
if($filas>=1){$reg=pg_fetch_array($res,0); $u_mes=$reg["u_conciliacion"]; if($mes==$u_mes){$error=0;}else{$error=1;?><script language="JavaScript">muestra('MES DE CONCILIACION, NO ES EL ULTIMO');</script><?php } }
