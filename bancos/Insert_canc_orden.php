<?php include ("../class/conect.php");  include ("../class/funciones.php"); include ("../presupuesto/Ver_dispon.php");include ("../class/configura.inc");error_reporting(E_ALL);
...
if (checkData($fecha_pago)=='1'){$error=0;}else{$error=1; ?> <script language="JavaScript">muestra('FECHA NO ES VALIDA');</script><?php }
if ($error==0){ $sfecha=formato_aaaammdd($fecha_pago); $rfecha=$sfecha;
  ...
  if($error==0){
    ...
    else {$error=1;?><script language="JavaScript">muestra('NUMERO ORDEN DE PAGO NO VALIDA');</script><?php }
  }
  if($error==0){    
    if($refierea=="CAUSADO"){
    ...
    } else { $error=1;?><script language="JavaScript">muestra('TIPO DE PAGO NO VALIDO');</script><?php } 
  }
  if($error==0){
  ...
  if($error==0){ $sfecha=formato_aaaammdd($fecha_pago);
     ...
     if (!$resultado){echo $error; $error=substr($error, 0, 61);?><script language="JavaScript"> muestra('<?php  echo $error; ?>');</script><?php  $error=1;}
...
if ($error==0){?><script language="JavaScript">document.location ='Cancelacion_Orden_Pago.php';</script> <?php } else {?>  <script language="JavaScript">history.back();</script> <?php } 
?>