...
<table width="800" height="50" border="0" >
  <tr>
    ...
    <td width="200"> <input name="btImprimir" type="button" id="btImprimir" value="Imprimir" onClick="javascript:window.open('../bancos/rpt/imprimir_auditoria.php?criterio=<?php  echo $txt_criterio ?>&fechaop=<?php  echo $fecha_aud ?>');" >
	</td>
  </tr>
  <tr>
