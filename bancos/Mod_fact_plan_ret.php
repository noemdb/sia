...
var Valido=true;
   ...
   if(f.txtnro_factura.value==""){alert("N�mero de Factura no puede estar Vacio"); return false;}else{f.txtnro_factura.value=f.txtnro_factura.value.toUpperCase();}
   if(f.txtnro_con_factura.value==""){alert("N�mero de Control no puede estar Vacio"); return false;}else{f.txtnro_con_factura.value=f.txtnro_con_factura.value.toUpperCase();}
      ...
      <td width="899"><table width="659" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="654">
            <tr>
              ...
              <td width="183"><input class="Estilo10" name="txtnro_factura" type="text"  id="txtnro_factura" size="22" maxlength="20"  value="<?php echo $nro_factura?>" readonly ></td>
              <td width="123"><span class="Estilo5">FECHA FACTURA:</span></td>
              <td width="175"><input class="Estilo10" name="txtfecha_factura" type="text" id="txtfecha_factura" size="12" maxlength="10" onFocus="encender(this);" onBlur="apaga_fecha(this)"  onchange="chequea_fecha(this.form);" value="<?php echo $fecha_factura?>"></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="655" border="0">
              <tr>
                ...
                <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtnro_con_factura" type="text" id="txtnro_con_factura"  size="22" maxlength="20" onFocus="encender(this); " onBlur="apaga_cont(this)"  onchange="chequea_control(this.form);"  value="<?php echo $nro_con_factura?>">   </span></td>
                <td width="126"><span class="Estilo5">RIF FACTURA :</span></td>
                <td width="175"><span class="Estilo5"><input class="Estilo10" name="txtrif_fact" type="text"  id="txtrif_fact"  value="<?php echo $rif_factura?>" size="12" maxlength="12" onFocus="encender_monto(this)" onBlur="apagar_monto(this)"> </span> </td>
        ...
        <tr>
          <td><table width="655" border="0">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_sin_iva" type="text" id="txtmonto_sin_iva" size="22" style="text-align:right"  onFocus="encende_monto(this);" onBlur="apaga_monto(this)"  onchange="chequea_monto(this.form);" value="<?php echo $monto_sin_iva?>" onKeypress="return validarNum(event)"> </span></td>
              <td width="124"><span class="Estilo5">TASA DE IVA:</span></td>
              <td width="177"><span class="Estilo5"><input class="Estilo10" name="txttasa_iva" type="text" id="txttasa_iva" size="6" maxlength="5" style="text-align:right"  onFocus="encender_monto(this);" onBlur="apaga_tasa(this)" onchange="chequea_tasa(this.form);" value="<?php echo $tasa_iva1?>" onKeypress="return validarNum(event)">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="654" border="0">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_iva1_so" type="text" id="txtmonto_iva1_so" size="22" style="text-align:right"  onFocus="encender_monto(this);" onBlur="apaga_objeto(this)"  onchange="chequea_objeto(this.form);" value="<?php echo $monto_iva1_so?>" onKeypress="return validarNum(event)"> </span> </td>
              <td width="126"><span class="Estilo5">MONTO CON IVA :</span></td>
              <td width="175"><span class="Estilo5"><input class="Estilo10" name="txtmonto_factura" type="text" id="txtmonto_factura" size="22" style="text-align:right"  maxlength="22" onFocus="encender_monto(this)" onBlur="apagar_monto(this)" value="<?php echo $monto_factura?>" onKeypress="return validarNum(event)">  </span></td>
            </tr>
          </table>            </td>
        </tr>
		<tr>
          <td><table width="654" border="0">
            <tr>
              ...
              <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto_iva4_so" type="text" id="txtmonto_iva4_so" size="22" style="text-align:right"  onFocus="encende_obj_ret(this);" onBlur="apaga_obj_ret(this)"  value="<?php echo $monto_iva4_so?>" onKeypress="return validarNum(event)">  </span> </td>
			  ...
			  <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto_iva3" type="text" id="txtmonto_iva3" size="20" style="text-align:right"  value="<?php  echo $monto_iva3 ?>" onFocus="encender_monto(this);" onBlur="apagar(this)" onKeypress="return validarNum(event)"> </span> </td>
        ...
        <table width="595" align="center">
          <tr>
			...
			<td width="20"><input name="txtcampo_str2" type="hidden" id="txtcampo_str2" value="<?php echo $campo_str2?>"></td>
            ...
            <td width="96" align="center"><input name="Eliminar" type="button" id="Eliminar" value="Eliminar" onClick="JavaScript:llamar_eliminar('<?php  echo $codigo_mov; ?>')"></td>
