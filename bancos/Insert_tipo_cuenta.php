...
if (pg_last_error($conn)) { ?>  <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if ($filas>0){ $error=1; ?>  <script language="JavaScript">  muestra('TIPO DE CUENTA YA EXISTE');  </script> <?php }
...
if ($error==0){?><script language="JavaScript">document.location='Act_Tipos_Cuentas.php?Gtipo_cuenta=U';</script> <?php } else {?>  <script language="JavaScript">history.back();</script> <?php }?>