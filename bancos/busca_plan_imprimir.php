...
pg_close($conn); $url="../pagos/rpt/".$nombre_planilla."?orden=".$nro_orden.'&tipo='.$tipo_p; //echo $url;
IF($error==0){?> <script language="JavaScript"> document.location ='<?php  echo $url; ?>'; </script> <?php } else{?> <script language="JavaScript"> window.close();  </script><?php }
?>