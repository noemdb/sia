...
function llamar_impimir(){var murl;var r;var f=document.form1;var tipo_p;
  tipo_p=f.txtplanilla.value;
  if(tipo_p=="00"){alert("Tipo de Planilla Invalida");}
  else{  murl="Desa Imprimir Planilla de Retenci�n ?";  r=confirm(murl);
    if(r==true){murl="/sia/pagos/rpt/Rpt_comp_ret_iva.php?nro_planilla=<?php echo $nro_planilla?>&planilla=<?php echo $planilla?>";
        dwindow.open(url);}
    }
}
        ...
        <tr>
          <td><table width="737">
            <tr>
              ...
              <td width="556"><span class="Estilo5"><input class="Estilo10" name="txtdescripcion_ret" type="text" id="txtdescripcion_ret"  readonly  size="90" value="<?php  echo $descripcion_ret ?>"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="733" border="0">
              <tr>
                ...
                <?php   if($planilla=="00"){?>
                <td width="20"><span class="Estilo5"><input class="Estilo10" name="txtplanilla" type="text" id="txtplanilla" title="Registre el tipo de Planilla" value="<?php  echo $planilla ?>"  size="2" maxlength="2" onFocus="encender(this)" onBlur="apagar(this)"  onchange="chequea_planilla(this.form);">  </span></td>
                <?php   } else {?>
