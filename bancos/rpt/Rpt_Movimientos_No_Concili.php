...
$nro_cuenta=$registro["nro_cuenta"];
    ...
    if($tipo_rep=="EXCEL"){	
		  ...
		  <?php   $i=0;  $totald=0; $totalc=0; $prev_cod_banco="";  $res=pg_query($sSQL);
		  while($registro=pg_fetch_array($res)){ $i=$i+1;  $cod_banco=$registro["cod_banco"];  $nombre_banco=$registro["nombre_banco"]; $nro_cuenta=$registro["nro_cuenta"];
			    ...
			    if(($totald>0)or($totalc>0)){ $totald=formato_monto($totald); $totalc=formato_monto($totalc); 			
			     ?>	 				 
			      ...
			      <tr>
				      ...
				      <td width="100" align="left"></td>
			          <td width="100" align="left"></td>
			          <td width="100" align="right"><?php  echo "Total: ".$prev_cod_banco; ?></td>
			   ...
			   ?>	   
				<tr>
				   ...
				   <td width="400" align="justify"><?php  echo $desc_m; ?></td>
		  ...
		  if(($totald>0)or($totalc>0)){ $totald=formato_monto($totald); $totalc=formato_monto($totalc); 
			...
			<tr>
			    ...
			    <td width="100" align="left"></td>
			    <td width="100" align="right"></td>
			    <td width="400" align="right"><?php  echo "Total: ".$cod_banco; ?></td>
			    <td width="100" align="right"><?php  echo $totald; ?></td>
			    <td width="100" align="right"><?php  echo $totalc; ?></td>
			</tr>	
		  <?php }	  
