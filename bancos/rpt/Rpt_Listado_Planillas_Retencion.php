        ...
        <tr>
          <td height="19" colspan="3" ><table width="776" border="0">
            <tr>
              ...
              <td width="200"><span class="Estilo5"> <input class="Estilo10" name="txttipo_planilla_ret_d" type="text" id="txttipo_planilla_ret_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_planilla_d?>" size="4" maxlength="2">   </span> </span></td>
              <td width="48">&nbsp;</td>
              <td width="277"><span class="Estilo5"><input class="Estilo10" name="txttipo_planilla_ret_h" type="text" id="txttipo_planilla_ret_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_planilla_h?>" size="4" maxlength="2">  </span></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19" colspan="3" ><table width="776" border="0">
            <tr>
              ...
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtnum_planilla_ret_d" type="text" id="txtnum_planilla_ret_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $numero_planilla_d?>" size="10" maxlength="8">
              </span></td>
              <td width="46">&nbsp;</td>
              <td width="279"><span class="Estilo12"><span class="Estilo5">
                <input class="Estilo10" name="txtnum_planilla_ret_h" type="text" id="txtnum_planilla_ret_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $numero_planilla_h?>" size="10" maxlength="8">
              </span></span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19" colspan="3" ><table width="783" border="0"  cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="253" align="left"><span class="Estilo5"> <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
                  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario1" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></div></td>
              <td width="286" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
        ...
        <tr>
          <td height="19" colspan="3"><table width="776" border="0">
            <tr>
              ...
              <td width="202"><span class="Estilo5"><input class="Estilo10" name="txttasa_d" type="text" id="txttasa_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tasa_d?>" size="8" maxlength="6">
              </span></td>
              <td width="47">&nbsp;</td>
              <td width="273"><span class="Estilo5"><input class="Estilo10" name="txttasa_h" type="text" id="txttasa_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tasa_h?>" size="8" maxlength="6">
              </span></td>
            </tr>
          </table></td>
        </tr>
