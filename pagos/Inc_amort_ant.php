...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Registrar Amortizaci�n de Anticipo)</title>
...
function llamar_anterior(){ document.location ='Det_inc_comp_orden.php?codigo_mov=<?php echo $codigo_mov?>'; }
function revisar(){
