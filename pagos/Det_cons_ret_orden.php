...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:muestra_pago_ret('<?php  echo $registro["status_r"]; ?>','<?php  echo $fecha; ?>','<?php  echo $registro["tipo_pago_r"]; ?>','<?php  echo $registro["nro_cheque_r"]; ?>');" >
           ...
           <td width="500" align="left"><?php  echo $concepto_ret; ?></td>
