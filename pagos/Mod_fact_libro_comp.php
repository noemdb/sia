...
function llamar_anterior(){document.location ='Det_inc_libro_comp.php?codigo_mov=<?php echo $codigo_mov?>&agregar=<?php echo $agregar?>';}
...
var murl; var r; var f=document.form1; var tipo_doc; var tipo_p; var orden;
  ...
  if(r==true){ r=confirm("Esta Realmente seguro en Eliminar el Documento del Libro de Compra  ?");
      if(r==true){murl="Delete_fact_libro_comp.php?codigo_mov=<?php echo $codigo_mov?>&agregar=<?php echo $agregar?>&tipo="+tipo_r+"&orden="+orden;document.location=murl;}}
      ...
      <td><table width="741" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
          <td><table width="737" >
            <tr>
			  ...
			  <td width="87"><span class="Estilo5"><input class="Estilo10" name="txtced_rif" type="text" id="txtced_rif" size="12" maxlength="12" onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $ced_rif ?>" > </span></td>
              ...
              <td width="479"></span><span class="Estilo5"><input class="Estilo10" name="txtnombre" type="text" id="txtnombre" size="70" readonly value="<?php  echo $nombre ?>" > </span></td>
            </tr>
          </table></td>
		</tr>
        <tr>
          <td><table width="729" >
            <tr>
              ...
              <td width="109"><span class="Estilo5"> <input class="Estilo10" name="txtnro_orden" type="text" id="txtnro_orden" size="3" maxlength="3" value="<?php  echo $nro_orden ?>"  readonly>  </span></td>
        ...
        <tr>
          <td><table width="733" border="0">
              <tr>
                ...
                <td width="195"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto"  size="15" maxlength="15" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<?php  echo $monto ?>"  onKeypress="return validarNum(event)"> </span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="737" border="0">
            <tr>
              ...
              <td width="193"> <span class="Estilo5"><input class="Estilo10" name="txtmontos" type="text" id="txtmontos" size="20" maxlength="20" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)"  value="<?php  echo $montos ?>"  onKeypress="return validarNum(event)">  </span> </td>
               <td width="137"><span class="Estilo5">BASE IMPONIBLE :  </span></td>
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtmontob" type="text" id="txtmontob" size="20" maxlength="20" style="text-align:right" onFocus="encender_monto(this)"  onBlur="apaga_monto(this)"  onchange="chequea_monto(this.form);"  value="<?php  echo $montob ?>"  onKeypress="return validarNum(event)">  </span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="192"><span class="Estilo5"><input class="Estilo10" name="txttasa" type="text" id="txttasa" size="8" maxlength="8"  style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" onchange="chequea_tasa(this.form);" value="<?php  echo $tasa ?>"  onKeypress="return validarNum(event)"> </span></td>
              <td width="138"><span class="Estilo5">MONTO IVA: </span></td>
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtmontoi" type="text" id="txtmontoi" size="20" maxlength="20" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<?php  echo $montoi ?>"  onKeypress="return validarNum(event)"></span></td>
              </tr>
          </table> </td>
        </tr>
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="190"><span class="Estilo5"><input class="Estilo10" name="txtretenc" type="text" id="txtretenc" size="10" maxlength="10"  style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" onchange="chequea_retenc(this.form);" value="<?php  echo $retenc ?>"  onKeypress="return validarNum(event)"> </span></td>
              <td width="139"><span class="Estilo5"> IVA RETENIDO : </span></td>
             <td width="203"><span class="Estilo5"><input class="Estilo10" name="txtmontor" type="text" id="txtmontor" size="15" maxlength="15" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)"  value="<?php  echo $montor ?>"  onKeypress="return validarNum(event)"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
            <td><table width="739" >
                <tr>
                  <td width="89"><span class="Estilo5">CONCEPTO:</span></td>
				   <td width="650"><textarea name="txttipo_en" cols="70"  onFocus="encender(this)" onBlur="apagar(this)" maxlength="100" class="Estilo10" id="txttipo_en"><?php echo $tipo_en?></textarea></td>
                  </span></td>
                </tr>
            </table></td>
          </tr>
        ...
        <table width="699" align="center">
          <tr>
            ...
            <td width="50"><input name="txttipo_operacion" type="hidden" id="txttipo_operacion" value="<?php echo $tipo_operacion?>"></td>
            <td width="50"><input name="txtagregar" type="hidden" id="txtagregar" value="<?php echo $agregar?>"></td>
            <td width="30"><input name="txttipo_retencion" type="hidden" id="txttipo_retencion" value="<?php echo $tipo_r?>"></td>
			<td width="30"><input name="txttipo_planilla" type="hidden" id="txttipo_planilla" value="<?php echo $tipo_planilla?>"></td>
