        ...
        <tr>
          <td><table width="737">
            <tr>
              ...
              <td width="50"><input class="Estilo10" name="bttiporet" type="button" id="bttiporet" title="Abrir Catalogo Tipos de Retenci�n" onclick="VentanaCentrada('Cat_tipo_ret.php?criterio=','SIA','','750','500','true')" value="..."></td>
        ...
        <tr>
          <td><table width="733" border="0">
            <tr>
              ...
              <td width="77"><span class="Estilo5"><input class="Estilo10" name="txttasa" type="text" id="txttasa" size="6" maxlength="6" align="right" onFocus="encender(this)" onBlur="apaga_tasa(this)" onchange="chequea_tasa(this.form);" value="<?php  echo $tasa ?>" onKeypress="return validarNum(event)"> </span></td>
        ...
        <tr>
          <td><table width="733" border="0">
              <tr>
                ...
                <td width="60"><span class="Estilo5"><input class="Estilo10" name="txtplanilla" type="text" id="txtplanilla" title="Registre el tipo de Planilla" value="<?php  echo $planilla ?>"  size="2" maxlength="2" onFocus="encender(this)" onBlur="apagar(this)"  onchange="chequea_planilla(this.form);">  </span></td>
                ...
                <td width="100"><span class="Estilo5"><div id="nroplan"> <input class="Estilo10" name="txtnro_planilla" type="text" id="txtnro_planilla"  size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $nro_planilla ?>"> </div></span></td>
               </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="151"><span class="Estilo5"><input class="Estilo10" name="txtmonto1" type="text" id="txtmonto1" size="20" maxlength="20" align="right" onFocus="encender(this)" onBlur="apaga_monto1(this)"  value="<?php  echo $monto1 ?>" onKeypress="return validarNum(event)"> </span></td>
              <td width="94"><span class="Estilo5">MONTO IVA: </span></td>
             <td width="126"><span class="Estilo5"><input class="Estilo10" name="txtmonto2" type="text" id="txtmonto2" size="15" maxlength="15" align="right" onFocus="encender(this)" onBlur="apaga_monto2(this)"  value="<?php  echo $monto2 ?>" onKeypress="return validarNum(event)"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
