...
?> <input name="txtmonto" type="text" id="txtmonto" size="20" align="right" maxlength="20" onFocus="encender(this)" onBlur="apaga_monto(this);" onchange="checkmonto(this.form);" value="<?php  echo $monto?>"> <?php  pg_close($conn);?>