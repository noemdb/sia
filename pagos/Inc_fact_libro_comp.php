      ...
      <td><table width="741" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="729" >
            <tr>
              ...
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtdocumento" type="text" id="txtdocumento" size="4" maxlength="2" onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $tipo_documento ?>"> </span></td>
              <td width="220"><span class="Estilo5">FECHA DOCUMENTO:</span></td>
              <td width="185"><span class="Estilo5"><input class="Estilo10" name="txtfecha_doc" type="text" id="txtfecha_doc" size="10" maxlength="10" onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $fecha ?>"></span></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="192"><span class="Estilo5"><input class="Estilo10" name="txttasa" type="text" id="txttasa" size="8" maxlength="8"  style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" onchange="chequea_tasa(this.form);" value="<?php  echo $tasa_iva ?>" onKeypress="return validarNum(event)"> </span></td>
		...
		<tr>
            <td><table width="739" >
                <tr>
                  ...
                  <td width="650"><span class="Estilo5"> <input class="Estilo10" name="txttipo_en" type="text" id="txttipo_en" value="<?php echo $tipo_en?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="100" size="110">
                  </span></td>
                </tr>
            </table></td>
        </tr>
        ...
        <table width="699" align="center">
          <tr>
			...
			<td width="60"><input name="txttipo_planilla" type="hidden" id="txttipo_planilla" value="<?php echo $tipo_planilla?>"></td>
