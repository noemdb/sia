        ...
        <tr>
          <td><table width="733" border="0">
              <tr>
                ...
                <td width="195"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto"  size="15" maxlength="15" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  value="<?php  echo $monto ?>"> </span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="737" border="0">
            <tr>
              ...
              <td width="193"> <span class="Estilo5"><input class="Estilo10" name="txtmontos" type="text" id="txtmontos" size="20" maxlength="20" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  value="<?php  echo $montos ?>">  </span> </td>
               <td width="137"><span class="Estilo5">BASE IMPONIBLE :  </span></td>
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtmontob" type="text" id="txtmontob" size="20" maxlength="20" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  onchange="chequea_monto(this.form);"  value="<?php  echo $montob ?>">  </span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="192"><span class="Estilo5"><input class="Estilo10" name="txttasa" type="text" id="txttasa" size="8" maxlength="8"  style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)" onchange="chequea_tasa(this.form);" value="<?php  echo $tasa_iva ?>"> </span></td>
              <td width="138"><span class="Estilo5">MONTO IVA : </span></td>
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtmontoi" type="text" id="txtmontoi" size="20" maxlength="20" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)" value="<?php  echo $montoi ?>"></span></td>
              </tr>
          </table> </td>
        </tr>
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="190"><span class="Estilo5"><input class="Estilo10" name="txtretenc" type="text" id="txtretenc" size="10" maxlength="10"  style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)" onchange="chequea_retenc(this.form);" value="<?php  echo $retenc ?>"> </span></td>
              <td width="139"><span class="Estilo5"> IVA RETENIDO : </span></td>
             <td width="203"><span class="Estilo5"><input class="Estilo10" name="txtmontor" type="text" id="txtmontor" size="15" maxlength="15" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  value="<?php  echo $montor ?>"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td><p>&nbsp;</p></td> </tr>
