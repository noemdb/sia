...
var Gcodigo = "<?php echo $codigo?>";
var Gfuente = "<?php echo $fuente?>";
var Gcodigo_mov = "<?php echo $codigo_mov?>";
var Gtipo = "<?php echo $tipo?>";
var Greferencia = "<?php echo $referencia?>";
var Gref_imput = "<?php echo $ref_imput_presu?>";
        ...
        <tr>
          <td><table width="620">
            <tr>
              ...
              <td width="82"><input class="Estilo10" name="txttipo_compromiso" type="text"  id="txttipo_compromiso" size="6" maxlength="4" readonly value="<?php  echo $tipo ?>"></td>
              <td width="144"><span class="Estilo5">REFERENCIA :</span></td>
              <td width="187"><input class="Estilo10" name="txtreferencia_comp" type="text" id="txtreferencia_comp" size="12" readonly value="<?php  echo $referencia ?>" ></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="620" border="0">
              <tr>
                ...
                <td width="217"><span class="Estilo5"><input class="Estilo10" name="txtcod_presup" type="text" id="txtcod_presup" title="Registre el C&oacute;digo de la Cuenta" value="<?php  echo $cod_presup ?>"  size="30" maxlength="30" readonly>
                </span></td>
                <td width="103">&nbsp;</td>
                <td width="51">&nbsp;</td>
                <td width="59">&nbsp;</td>
        ...
        <tr>
          <td><table width="623" border="0">
            <tr>
              ...
              <td width="22"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuente" type="text" id="txtcod_fuente" value="<?php  echo $cod_fuente ?>" size="3" maxlength="2" readonly>
              </span></td>
              <td width="17">&nbsp;</td>
              <td width="351"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuente" type="text" id="txtdes_fuente" value="<?php  echo $des_fuente ?>" size="50" readonly>
              </span></td>
            </tr>
          </table></td>
        </tr>
          ...
          <td><span class="Estilo5"> </span>
            <table width="621" border="0">
              <tr>
                ...
                <td width="494"><span class="Estilo5"><textarea name="txtdenominacion" class="Estilo10" cols="58" rows="1" readonly="readonly" id="txtdenominacion"><?php  echo $denominacion ?></textarea>
                </span></td>
              </tr>
            </table>            </td>
        </tr>
          ...
          <td><span class="Estilo5"> </span>
              <table width="614" border="0">
                <tr>
                  ...
                  <td width="496"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" onFocus="encende_monto(this)" onBlur="apaga_monto(this)" value="<?php  echo $monto ?>" size="25" maxlength="22"  style="text-align:right"  onKeypress="return validarNum(event)">
                  </span></td>
                </tr>
            </table></td>
        </tr>
		<tr>
          <td><table width="620">
            <tr>
              ...
              <td width="140"><span class="Estilo5"> <input class="Estilo10" name="txttipo_imput_presu" type="text" id="txttipo_imput_presu"  value="<?php echo $tipo_imput_presu?>" size="20" readonly class="Estilo5"></span></td>
              <td width="200"><span class="Estilo5">REFERENCIA DEL CREDITO ADICIONAL:</span></td>
              <td width="80"><input class="Estilo10" name="txtref_imput_presu" type="text"  id="txtref_imput_presu" value="<?php echo $ref_imput_presu?>" size="12" readonly class="Estilo5"></td>             
            </tr>
          </table></td>
        </tr>
        <tr>
