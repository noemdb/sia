...
var tipo_en; var tipo_doc;  var nro_doc;  var nro_con; var fecha_f; var tipo_p;
  ...
  if(tipo_p=="00"){alert("Tipo de Planilla Invalida");}
    ...
    else{murl="Update_plan_ret.php?codigo_mov=<?php echo $codigo_mov?>&orden=<?php echo $orden?>&tipo=<?php echo $tipo_ret?>&nro_planilla=<?php echo $nro_planilla?>&planilla=<?php echo $planilla?>&tipo_en="+tipo_en+"&tipo_d="+tipo_doc+"&nro_doc="+nro_doc+"&nro_con_f="+nro_con+"&fecha_f="+fecha_f+"&monto1="+monto1+"&monto2="+monto2;  document.location=murl;} }
}
function llamar_eliminar(){var murl;var r;var f=document.form1;var tipo_op; var tipo_p;
  ...
  if(tipo_p=="00"){alert("Tipo de Planilla Invalida");}
    ...
    if(r==true){ r=confirm("Esta Realmente seguro en Eliminar la Planilla de Retencion ?");
      if(r==true){murl="Delete_plan_ret.php?codigo_mov=<?php echo $codigo_mov?>&orden=<?php echo $orden?>&tipo=<?php echo $tipo_ret?>&nro_planilla=<?php echo $nro_planilla?>&planilla=<?php echo $planilla?>&tipo_op="+tipo_op;document.location=murl;}}
...
function llamar_anular(){var murl;var r;var f=document.form1;var tipo_p;
  ...
  if(tipo_p=="00"){alert("Tipo de Planilla Invalida");}
    ...
    if(r==true){r=confirm("Esta Realmente seguro en Anular la Planilla de Retencion ?");
      if(r==true){murl="Anula_plan_ret.php?codigo_mov=<?php echo $codigo_mov?>&orden=<?php echo $orden?>&tipo=<?php echo $tipo_ret?>&nro_planilla=<?php echo $nro_planilla?>&planilla=<?php echo $planilla?>"  ;document.location=murl;}}
     else { url="Cancelado, no elimino"; }
  }
}
function llamar_impimir(){var murl;var r;var f=document.form1;var tipo_p;
  ...
  if(tipo_p=="00"){alert("Tipo de Planilla Invalida");}
    ...
    if(r==true){murl="/sia/pagos/rpt/Rpt_planilla_ret.php?nro_planilla=<?php echo $nro_planilla?>&planilla=<?php echo $planilla?>";
        dwindow.open(url);}
    }
}
...
function revisar(){var f=document.form1; var Valido=true;
   if(f.txtnro_orden.value==""){alert("N�mero de Orden no puede estar Vacio");return false;}
      ...
      <td><table width="741" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="737">
            <tr>
              ...
              <td width="48"><span class="Estilo5"><input class="Estilo10" name="txttipo_retencion" type="text" id="txttipo_retencion" size="3" maxlength="3" value="<?php  echo $tipo_ret ?>"  readonly></span></td>
              <td width="556"><span class="Estilo5"><input class="Estilo10" name="txtdescripcion_ret" type="text" id="txtdescripcion_ret"  readonly  size="85" value="<?php  echo $descripcion_ret ?>"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="733" border="0">
            <tr>
              ...
              <td width="77"><span class="Estilo5"><input class="Estilo10" name="txttasa" type="text" id="txttasa" size="6" maxlength="6" style="text-align:right"  readonly value="<?php  echo $tasa ?>"> </span></td>
              <td width="111"><span class="Estilo5">MONTO OBJETO :</span></td>
              <td width="215"><span class="Estilo5"><input class="Estilo10" name="txtmonto_objeto" type="text" id="txmonto_objeto" size="25" style="text-align:right"  maxlength="22" readonly value="<?php  echo $monto_o ?>"></span></td>
              <td width="83"><span class="Estilo5">RETENCI&Oacute;N:</span></td>
              <td width="174"><span class="Estilo5"><input class="Estilo10" name="txtmonto_retencion" type="text" id="txtmonto_retencion" size="25" style="text-align:right"  maxlength="22" readonly value="<?php  echo $monto_r ?>"></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="733" border="0">
              <tr>
                <td width="106"><span class="Estilo5">TIPO PLANILLA :</span></td>
                                <?php   if($planilla=="00"){?>
                <td width="12"><span class="Estilo5"><input class="Estilo10" name="txtplanilla" type="text" id="txtplanilla" title="Registre el tipo de Planilla" value="<?php  echo $planilla ?>"  size="2" maxlength="2" onFocus="encender(this)" onBlur="apagar(this)"  onchange="chequea_planilla(this.form);">  </span></td>
                <?php   } else {?>
                                <td width="20"><span class="Estilo5"><input class="Estilo10" name="txtplanilla" type="text" id="txtplanilla" value="<?php  echo $planilla ?>"  size="2" maxlength="2" readonly>  </span></td>
                <?php   }?>
                <td width="315"><span class="Estilo5"><div id="desplan"><input class="Estilo10" name="txtdescripcion" type="text" id="txtdescripcion" size="50" value="<?php  echo $descripcion ?>" readonly> </div></span></td>
                <td width="103"><span class="Estilo5">NRO. PLANILLA :</span></td>
                                <?php   if($planilla=="00"){?>
                <td width="62"><span class="Estilo5"><div id="nroplan">
                  <input class="Estilo10" name="txtnro_planilla" type="text" id="txtnro_planilla"  size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $nro_planilla ?>"> </div></span></td>
                <?php   } else {?>
                                <td width="85"><span class="Estilo5"><input class="Estilo10" name="txtnro_planilla" type="text" id="txtnro_planilla" size="10" maxlength="8"  readonly value="<?php  echo $nro_planilla ?>"> </span></td>
                <?php   }?>
                          </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="97"><span class="Estilo5"><input class="Estilo10" name="txtfecha" type="text" id="txtfecha" size="10" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php  echo $fecha ?>"> </span></td>
              <td width="115"><span class="Estilo5">TOTAL FACTURA: </span></td>
              <td width="151"><span class="Estilo5"><input class="Estilo10" name="txtmonto1" type="text" id="txtmonto1" size="20" maxlength="20" style="text-align:right"  onFocus="encender_monto(this)" onBlur="apaga_monto1(this)"  value="<?php  echo $monto1 ?>" onKeypress="return validarNum(event)"> </span></td>
              <td width="94"><span class="Estilo5">MONTO IVA: </span></td>
             <td width="126"><span class="Estilo5"><input class="Estilo10" name="txtmonto2" type="text" id="txtmonto2" size="15" maxlength="15" style="text-align:right"  onFocus="encender_monto(this)" onBlur="apaga_monto2(this)"  value="<?php  echo $monto2 ?>" onKeypress="return validarNum(event)"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td><p>&nbsp;</p> </td> </tr>
        ...
        <table width="740" align="center">
          <tr>
            ...
            <td width="10"><input name="txttipo_operacion" type="hidden" id="txttipo_operacion" value="<?php echo $tipo_operacion?>"></td>
            <td width="10"><input name="txtret_grupo" type="hidden" id="txtret_grupo" value="<?php echo $ret_grupo?>"></td>
			<?php if ($Mcamino{0}=="S"){?>
