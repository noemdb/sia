...
?> <input class="Estilo10" name="txtdes_tipo_orden" type="text" id="txtdes_tipo_orden" size="80" readonly value="<?php  echo $des_tipo_orden?>" onkeypress="return stabular(event,this)" ><?php 
pg_close($conn);?>