<?php include ("../class/conect.php");  include ("../class/funciones.php"); if (!$_GET){$codigo_mov='';}else{$codigo_mov=$_GET["codigo_mov"];} $cod_contable="";$monto_am_ant=0;$amort_ant="NO";
...
<body>
  <table width="888" border="0" cellspacing="0" cellpadding="0">
   <tr>
     ...
     <td  width="256" align="left"><span class="Estilo5"><input name="txtcod_contable" type="text" id="txtcod_contable" size="25" maxlength="30" value="<?php echo $cod_contable?>" readonly></span></td>
   </tr>
   <tr>
