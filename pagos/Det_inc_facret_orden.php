...
<body>
 <table width="904" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td width="164">&nbsp;</td>
     <td width="459"><input name="btCargar" type="button" id="btCargar" value="Cargar" title="Cargar Ordenes de Retencion a Cancelar" onclick="javascript:LlamarURL('Carga_fact_sin_ret.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
...
?>
       <table width="800"  border="1" cellspacing='0' cellpadding='0' align="left" id="ord_ret_canceladas">
         ...
         <?php  $total=0; $monto=0; $subtotal=0; 
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_seleccion('<?php  echo $codigo_mov; ?>','<?php  echo $registro["nro_factura"]; ?>','<?php  echo $registro["status_2"] ?>');">
           <td width="20" align="left"><?php  echo $selec; ?></td>
		   <td width="100" align="left"><?php  echo $registro["campo_str1"]; ?></td>
		   <td width="150" align="left"><?php  echo $registro["nro_factura"]; ?></td>
           <td width="80" align="left"><?php  echo $fecha; ?></td>
           <td width="150" align="left"><?php  echo $registro["nro_con_factura"]; ?></td>
...
<?php }  $tiva=$total-$subtotal; $total=formato_monto($total); $subtotal=formato_monto($subtotal); $tiva=formato_monto($tiva);?>
       </table></td>
   </tr>
   <tr>
     <td colspan="4">&nbsp;</td>
