        ...
        <tr>
          <td><table width="614" border="0">
              <tr>
                ...
                <td width="69"><span class="Estilo5"><input name="txtcod_est" type="text" id="txtcod_est" title="Registre el Codigo de la Estructura"  size="10" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $codest?>">   </span></td>
                <td width="432"><input name="btCatest" type="button" id="btCatest" title="Abrir Catalogo Codigo de Estructuras"  onclick="VentanaCentrada('Cat_estructura.php?codigo_mov=<?php echo $codigo_mov?>&ref_comp=<?php echo $ref_comp?>','SIA','','750','500','true')" value="..."></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="740" border="0">
              <tr>
                ...
                <td width="589"><span class="Estilo5"><input name="txtdescripcion_est" type="text" id="txtdescripcion_est" size="95" maxlength="250" readonly value="<?php echo $desest?>"></span></td>
              </tr>
            </table> </td>
        </tr>
        <tr>
