...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="170" align="left"><?php  echo $fecha; ?></td>
           <td width="80" align="left"><?php  echo $registro["cod_banco"]; ?></td>
           <td width="170" align="left"><?php  echo $registro["nro_cheque"]; ?></td>
           <td width="100" align="right"><?php  echo $monto; ?></td>
           <td width="60" align="center"><?php  echo $registro["anulado"]; ?></td>
