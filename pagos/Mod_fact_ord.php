...
var Gfactura = "<?php echo $nro_factura?>";
...
function llamar_eliminar(codigo_mov,ref_comp){var murl;var r;
 if (Gfactura=="") {alert("Factura debe ser Seleccionada");}
  ...
  if(r==true){r=confirm("Esta Realmente seguro en Eliminar la Factura de la Orden ?");
    if(r==true){murl="Delete_fact_ord.php?codigo_mov="+codigo_mov+"&factura="+Gfactura+"&ref_comp="+ref_comp+"&ced_rif=<?php echo $ced_rif?>";document.location=murl;}
      ...
      <td width="899"><table width="659" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">MODIFICAR  FACTURA DE LA ORDEN</span></td>
            ...
            <tr>
              ...
              <td width="155"><input class="Estilo10" name="txttipo_compromiso" type="text"  id="txttipo_compromiso" size="6" maxlength="4" value="<?php echo $tipo_compromiso?>" readonly onkeypress="return stabular(event,this)"></td>
              <td width="129"><span class="Estilo5">REFERENCIA :</span></td>
              <td width="174"><input class="Estilo10" name="txtreferencia_comp" type="text" id="txtreferencia_comp" size="12" value="<?php echo $ref_compromiso?>" readonly onkeypress="return stabular(event,this)"></td>
            </tr>
          </table></td> </tr>  <?php }?>
        <tr>
          <td><table width="654">
            <tr>
              ...
              <td width="183"><input class="Estilo10" name="txtnro_factura" type="text"  id="txtnro_factura" size="25" maxlength="20" onFocus="encender(this);" value="<?php echo $nro_factura?>" readonly onkeypress="return stabular(event,this)"></td>
              <td width="123"><span class="Estilo5">FECHA DOCUMENTO:</span></td>
              <td width="175"><input class="Estilo10" name="txtfecha_factura" type="text" id="txtfecha_factura" size="12" maxlength="10" onFocus="encende_fecha(this);" onBlur="apaga_fecha(this)"  onchange="chequea_fecha(this.form);" value="<?php echo $fecha_factura?>" onkeyup="mascara(this,'/',patronfecha,true)" onkeypress="return stabular(event,this)"></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="655" border="0">
              <tr>
                ...
                <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtnro_con_factura" type="text" id="txtnro_con_factura"  size="25" maxlength="20" onFocus="encender(this); " onBlur="apaga_cont(this)"  onchange="chequea_control(this.form);"  value="<?php echo $nro_con_factura?>" onkeypress="return stabular(event,this)">   </span></td>
                <td width="182">&nbsp;</td>
                <td width="119">&nbsp;</td>
              </tr>
          </table></td>
        ...
        <tr>
          <td><table width="655" border="0">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_sin_iva" type="text" id="txtmonto_sin_iva" size="22" style="text-align:right" onFocus="encende_monto(this);" onBlur="apaga_monto(this)"  onchange="chequea_monto(this.form);" value="<?php echo $monto_sin_iva?>" onKeypress="return validarNum(event,this)"> </span></td>
              <td width="124"><span class="Estilo5">TASA DE IVA:</span></td>
              <td width="177"><span class="Estilo5"><input class="Estilo10" name="txttasa_iva" type="text" id="txttasa_iva" size="6" maxlength="5" style="text-align:right" onFocus="encender(this);" onBlur="apaga_tasa(this)" onchange="chequea_tasa(this.form);" value="<?php echo $tasa_iva1?>" onKeypress="return validarNum(event,this)">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="654" border="0">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_iva1_so" type="text" id="txtmonto_iva1_so" size="22" style="text-align:right" onFocus="encender(this);" onBlur="apaga_objeto(this)"  onchange="chequea_objeto(this.form);" value="<?php echo $monto_iva1_so?>" onKeypress="return validarNum(event,this)"> </span> </td>
              <td width="126"><span class="Estilo5">MONTO CON IVA :</span></td>
              <td width="175"><span class="Estilo5"><input class="Estilo10" name="txtmonto_factura" type="text" id="txtmonto_factura" size="22" style="text-align:right" maxlength="22" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $monto_factura?>" onKeypress="return validarNum(event,this)">  </span></td>
            </tr>
          </table>            </td>
        </tr>
		<tr>
          <td><table width="654" border="0">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_iva4_so" type="text" id="txtmonto_iva4_so" size="22" style="text-align:right" onFocus="encender(this);" onBlur="apaga_obj_ret(this)"  value="<?php echo $monto_iva4_so?>" onKeypress="return validarNum(event,this)">  </span> </td>
              <td width="126"><span class="Estilo5">RIF FACTURA :</span></td>
              <td width="175"><span class="Estilo5"><input class="Estilo10" name="txtrif_fact" type="text"  id="txtrif_fact"  value="<?php echo $rif_factura?>" size="14" maxlength="12" onFocus="encender(this)" onBlur="apagar(this)"> </span> </td>
           </tr>
          </table>            </td>
        </tr>
		<tr>
          <td><table width="655" border="0">
              <tr>
                ...
                <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_iva3_so" type="text" id="txtmonto_iva3_so" value="0" size="22" maxlength="20" style="text-align:right" onFocus="encender(this); " onBlur="apagar(this)" value="<?php echo $monto_iva3_so?>" onKeypress="return validarNum(event,this)">  </span></td>
                <td width="126"><span class="Estilo5">FACT AFECTADA:</span></td>
				<td width="175"><span class="Estilo5"><input class="Estilo10" name="txtcampo_str2" type="text" id="txtcampo_str2"  size="22" maxlength="20" onFocus="encender(this); " onBlur="apagar(this)" value="<?php echo $campo_str2?>" onkeypress="return stabular(event,this)">  </span></td>
               <?php } else{?>
                <td width="154"><span class="Estilo5">FACT AFECTADA:</span></td>
				<td width="182"><span class="Estilo5"><input class="Estilo10" name="txtcampo_str2" type="text" id="txtcampo_str2"  size="22" maxlength="20" onFocus="encender(this); " onBlur="apagar(this)" value="<?php echo $campo_str2?>" onkeypress="return stabular(event,this)">  </span></td>
                <td width="126">&nbsp;</td>
                <td width="175">&nbsp;</td>
				<?php }?>
              </tr>
        ...
        <table width="595" align="center">
          <tr>
			...
			<td width="20"><input name="txtcampo_str1" type="hidden" id="txtcampo_str1" value="<?php echo $campo_str1?>"></td>            
            <td width="30"><input name="txtref_comp" type="hidden" id="txtref_comp" value="<?php echo $ref_comp?>"></td>
            <td width="50"><input name="txtced_rif" type="hidden" id="txtref_comp" value="<?php echo $ced_rif?>"></td>
            ...
            <td width="96" align="center"><input name="Eliminar" type="button" id="Eliminar" value="Eliminar" onClick="JavaScript:llamar_eliminar('<?php  echo $codigo_mov; ?>','<?php  echo $ref_comp; ?>')"></td>
