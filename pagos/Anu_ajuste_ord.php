...
if (pg_last_error($conn)) { ?> <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1;?><script language="JavaScript">muestra('REFERENCIA AJUSTE DE ORDEN NO EXISTE');</script><?php }
     ...
     if($anulado=='S'){$error=1;?><script language="JavaScript">muestra('AJUSTE YA ESTA ANULADO');</script><?php }
	 ...
	 if($error==0){
       ...
       if (($error==0)and(substr($tipo_ajuste,0,1)=="A")){$error=1;?><script language="JavaScript">muestra('AJUSTE A ORDEN NO PUEDE SER ANULADO');</script><?php }
       if ($error==0){ $nmes=substr($fecha_anu,3,2); if($SIA_Periodo>$nmes){$error=1;?><script language="JavaScript">muestra('FECHA ANULACION MENOR A ULTIMO PERIODO CERRADO');</script><?php } }
	 }
