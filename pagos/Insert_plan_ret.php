...
if (pg_last_error($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('TIPO DE PLANILLA NO EXISTE');</script><?php }
    ...
    if($filas>0){$error=1; echo $sSQL,"<br>"; ?> <script language="JavaScript"> muestra('NUMERO PLANILLA DE RETENCION YA EXISTE');</script><?php }
    if($error==0){
      ...
      if ($filas==0){$error=1; echo $sSQL; ?> <script language="JavaScript"> muestra('ERROR LOCALIZANO DETALLE DE PLANILLA');</script><?php }
	...
	if(($error==0)and($nro_planilla=="00000000")){ $error=1; ?> <script language="JavaScript"> muestra('NUMERO PLANILLA DE INVALIDA');</script><?php }
