<?php include ("../class/conect.php");  include ("../class/funciones.php"); include ("../class/configura.inc"); include ("../presupuesto/Ver_dispon.php"); $codigo_mov=$_GET["codigo_mov"]; $ref_comp=$_GET["ref_comp"];?>
<html>
...
?> <script language="JavaScript">  muestra('<?php  echo $mensaje; ?>'); </script> <?php }
...
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txttipo_caus" type="hidden" id="txttipo_caus" value="<?php echo $tipo_causado?>" ></td>
	 ...
	 <td width="5"><input name="txtcon_est" type="hidden" id="txtcon_est" value="<?php echo $concepto?>"></td>
	 <td width="5"><input name="txttipo_doc" type="hidden" id="txttipo_doc" value="<?php echo $tipo_documento?>"></td>
     <td width="5"><input name="txtnro_doc" type="hidden" id="txtnro_doc" value="<?php echo $nro_documento?>"></td>
     <td width="5"><input name="txttipo_ord" type="hidden" id="txttipo_ord" value="<?php echo $tipo_orden?>"></td>
	 <td width="5"><input name="txtdes_t_orden" type="hidden" id="txtdes_t_orden" value="<?php echo $des_tipo_orden?>"></td>
     <td width="5"><input name="txtfecha_d" type="hidden" id="txtfecha_d" value="<?php echo $fecha_desde?>"></td>
     <td width="5"><input name="txtfecha_h" type="hidden" id="txtfecha_h" value="<?php echo $fecha_hasta?>"></td>
	 <td width="5"><input name="txtfecha_v" type="hidden" id="txtfecha_v" value="<?php echo $fecha_vencim?>"></td>	 
...
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txttipo_caus2" type="hidden" id="txttipo_caus2" value="<?php echo $tipo_causado?>" ></td>
	 ...
	 <td width="5"><input name="txtced_r2" type="hidden" id="txtced_r2" value="<?php echo $ced_rif ?>"></td>
     <td width="5"><input name="txtnomb_r2" type="hidden" id="txtnomb_r2" value="<?php echo $nombre ?>"></td>
	 <td width="5"><input name="txtcon_est2" type="hidden" id="txtcon_est2" value="<?php echo $concepto?>"></td>
     <td width="5"><input name="txttipo_doc2" type="hidden" id="txttipo_doc2" value="<?php echo $tipo_documento?>"></td>
     <td width="5"><input name="txtnro_doc2" type="hidden" id="txtnro_doc2" value="<?php echo $nro_documento?>"></td>
     <td width="5"><input name="txttipo_ord2" type="hidden" id="txttipo_ord2" value="<?php echo $tipo_orden?>"></td>
	 <td width="5"><input name="txtdes_t_orden2" type="hidden" id="txtdes_t_orden2" value="<?php echo $des_tipo_orden?>"></td>
     <td width="5"><input name="txtfecha_d2" type="hidden" id="txtfecha_d2" value="<?php echo $fecha_desde?>"></td>
     <td width="5"><input name="txtfecha_h2" type="hidden" id="txtfecha_h2" value="<?php echo $fecha_hasta?>"></td>
	 <td width="5"><input name="txtfecha_v2" type="hidden" id="txtfecha_v2" value="<?php echo $fecha_vencim?>"></td>
	 <td width="5"><input name="txtnro_ord2" type="hidden" id="txtnro_ord2" value="<?php echo $nro_orden?>"></td>
...
<?php    
pg_close($conn);
if ($error==0){?><script language="JavaScript">alert('Orden Pegada'); Llamar_Inc_Orden('<?php echo $ref_comp?>');</script> <?php }
