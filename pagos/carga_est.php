<?php include ("../class/conect.php");  include ("../class/funciones.php");  include ("../class/configura.inc"); $codigo_mov=$_POST["txtcodigo_mov"];
...
if($ref_comp=='N'){$res=pg_exec($conn,"UPDATE PRE026 set tipo_compromiso='0000',referencia_comp='00000000' where codigo_mov='$codigo_mov'");  $error=pg_errormessage($conn); $error=substr($error, 0, 61);if (!$res){ ?> <script language="JavaScript">  muestra('<?php  echo $error; ?>'); </script> <?php } }
    ...
    while(($registro=pg_fetch_array($res))){      $referencia_comp=$registro["referencia_comp"]; $tipo_compromiso=$registro["tipo_compromiso"];
	   ...
	   if ($regp=pg_fetch_array($resp,0)) { 
		 ...
		 $resu=pg_exec($conn,$sqlu);  $error=pg_errormessage($conn); $error=substr($error, 0, 61);if (!$resu){ ?> <script language="JavaScript">  muestra('<?php  echo $error; ?>'); </script> <?php } } 
	    }	   
	}
}}
?>
...
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txtcod_est" type="hidden" id="txtcod_est" value="<?php echo $codest?>" ></td>
     <td width="5"><input name="txtced_r" type="hidden" id="txtced_r" value="<?php echo $cedrifest?>"></td>
     <td width="5"><input name="txtnomb_r" type="hidden" id="txtnomb_r" value="<?php echo $nomb?>"></td>
     <td width="5"><input name="txtcon_est" type="hidden" id="txtcon_est" value="<?php echo $concepto_est?>"></td>
     <td width="5"><input name="txttipo_doc" type="hidden" id="txttipo_doc" value="<?php echo $tipo_doc?>"></td>
     <td width="5"><input name="txtnro_doc" type="hidden" id="txtnro_doc" value="<?php echo $nro_doc?>"></td>
     <td width="5"><input name="txttipo_ord" type="hidden" id="txttipo_ord" value="<?php echo $tipo_ord?>"></td>
     <td width="5"><input name="txtfecha_d" type="hidden" id="txtfecha_d" value="<?php echo $fecha_d?>"></td>
     <td width="5"><input name="txtfecha_h" type="hidden" id="txtfecha_h" value="<?php echo $fecha_h?>"></td>
...
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txtcod_est2" type="hidden" id="txtcod_est2" value="<?php echo $codest?>" ></td>
	 <td width="5"><input name="txtced_r2" type="hidden" id="txtced_r2" value="<?php echo $cedrif?>"></td>
     <td width="5"><input name="txtnomb_r2" type="hidden" id="txtnomb_r2" value="<?php echo $nomb?>"></td>
     <td width="5"><input name="txtcon_est2" type="hidden" id="txtcon_est2" value="<?php echo $concepto_est?>"></td>
     <td width="5"><input name="txttipo_doc2" type="hidden" id="txttipo_doc2" value="<?php echo $tipo_doc?>"></td>
     <td width="5"><input name="txtnro_doc2" type="hidden" id="txtnro_doc2" value="<?php echo $nro_doc?>"></td>
     <td width="5"><input name="txttipo_ord2" type="hidden" id="txttipo_ord2" value="<?php echo $tipo_ord?>"></td>
     <td width="5"><input name="txtfecha_d2" type="hidden" id="txtfecha_d2" value="<?php echo $fecha_d?>"></td>
     <td width="5"><input name="txtfecha_h2" type="hidden" id="txtfecha_h2" value="<?php echo $fecha_h?>"></td>
	 <td width="5"><input name="txtfecha_v2" type="hidden" id="txtfecha_v2" value=""></td>
	 <td width="5"><input name="txtfecha_fin2" type="hidden" id="txtfecha_fin2" value="<?php echo $Fec_Fin_Ejer?>"></td>
	 <td width="5"><input name="txtcod_emp2" type="hidden" id="txtcod_emp2" value="<?php echo $Cod_Emp?>" ></td>
...
<?php pg_close($conn);
/* */
if ($error==0){?><script language="JavaScript">Llamar_Inc_Orden('<?php  echo $ref_comp; ?>');</script> <?php }
