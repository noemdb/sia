 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="140" align="center" valign="middle"><?php  if($bloqueada=='N'){?><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Retencion a la Orden" onclick="javascript:LlamarURL('Inc_ret_orden.php?codigo_mov=<?php echo $codigo_mov?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>')"><?php }?> </td>
            <td width="200" align="center"><?php  if($bloqueada=='N'){?> <input name="btGenRetIva" type="button" id="btGenRetIva"  value="Gen. Retencion Iva" title="Generar Retenciones de Iva" onclick="javascript:LlamarURL('Inc_ret_iva.php?codigo_mov=<?php echo $codigo_mov?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>')"><?php }?> </td>
            <td width="200" align="center"><?php  if($bloqueada=='N'){?> <input name="btGenRetIslr" type="button" id="btGenRetIslr"  value="Gen. Retencion ISLR" title="Generar Retenciones de Islr" onclick="javascript:LlamarURL('Inc_ret_islr.php?codigo_mov=<?php echo $codigo_mov?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>')"><?php }?> </td>
            <td width="140" align="center"><?php  if($bloqueada=='N'){?> <input name="btGenRetotros" type="button" id="btGenRetotros"  value="Gen. Retencion Otro" title="Generar Retenciones de 1*100" onclick="javascript:LlamarURL('Inc_ret_otros.php?codigo_mov=<?php echo $codigo_mov?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>')"><?php }?> </td>
			<td width="200" align="center"><?php  if($bloqueada=='N'){?> <input name="btGenRetotros" type="button" id="btGenRetotros"  value="Gen. Retencion Lab." title="Generar Retenciones Laboral y Fiel" onclick="javascript:LlamarURL('Inc_ret_laboral.php?codigo_mov=<?php echo $codigo_mov?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>')"><?php }?> </td>
          </tr>
      </table></td>
    </tr>
    <tr height="10">
