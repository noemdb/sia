...
if (pg_last_error($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('NO EXISTEN CODIGOS AJUSTADOS');</script> <?php }
    ...
    if ($filas==0){$error=1;?><script language="JavaScript">muestra('NÚMERO DE ORDEN NO EXISTE');</script><?php }
