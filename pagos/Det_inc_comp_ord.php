...
<table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
		  <!--
            <td width="255" align="center"><?php  if($cod_tipo_orden=='0004'){?> <input name="btcargaest" type="button" id="btcargaest"  value="Carga Estructura" title="Carga Estructura" onclick="javascript:LlamarURL('Carga_est_emp.php?codigo_mov=<?php echo $codigo_mov?>&ced_emp=<?php echo $ced_emp?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>')"><?php }?> </td>
          -->  
   ...
   <tr>
     <td>
<?php $sql="SELECT * FROM COD_PRE026_ORD where codigo_mov='$codigo_mov' order by tipo_compromiso,referencia_comp,cod_presup"; $res=pg_query($sql);
?>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Modificar('<?php  echo $codigo_mov; ?>','<?php  echo $registro["cod_presup"]; ?>','<?php  echo $registro["fuente_financ"]; ?>','<?php  echo $registro["ref_imput_presu"]; ?>','<?php  echo $registro["referencia_comp"]; ?>','<?php  echo $registro["tipo_compromiso"]; ?>');">
           ...
           <td width="110" align="right"><?php  echo $monto_c; ?></td>
           ...
           <td width="120" align="left"><?php  echo $registro["ref_aep"]; ?></td>
           <td width="40" align="right"><?php  echo $tasa; ?></td>
         </tr>
