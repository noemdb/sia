...
function llamar_anterior(){document.location ='Det_inc_ajustes_orden.php?codigo_mov=<?php echo $codigo_mov?>';}
      ...
      <td><table width="692" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="620" border="0">
              <tr>
                ...
                <td width="217"><span class="Estilo5"><input class="Estilo10" name="txtcod_presup" type="text" id="txtcod_presup" title="Registre el C&oacute;digo de la Cuenta" value="<?php  echo $cod_presup ?>"  size="35" maxlength="32" readonly>   </span></td>
                <td width="103">&nbsp;</td>
                <td width="51">&nbsp;</td>
                <td width="59">&nbsp;</td>
              </tr>
        ...
        <tr>
          <td><table width="663" border="0">
            <tr>
              ...
              <td width="10">&nbsp;</td>
              <td width="401"><span class="Estilo5"> <input class="Estilo10" name="txtdes_fuente" type="text" id="txtdes_fuente" value="<?php  echo $des_fuente ?>" size="60" readonly>  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="678" border="0">
              <tr>
                ...
                <td width="494"><span class="Estilo5"><textarea name="txtdenominacion" cols="70" rows="2" readonly="readonly" id="txtdenominacion" class="Estilo10"><?php  echo $denominacion ?></textarea>
                </span></td>
              </tr>
            </table>            </td>
        </tr>
        <tr>
          <td><table width="681">
            <tr>
              ...
              <td width="184"><span class="Estilo5"><input class="Estilo10" name="txttipo_imput_presu" type="text" id="txttipo_imput_presu"  value="<?php echo $tipo_imput_presu?>" size="22" readonly>    </span> </td>
              <td width="244"><span class="Estilo5">REFERENCIA DEL CREDITO ADICIONAL:</span></td>
              <td width="72"><input class="Estilo10" name="txtref_imput_presu" type="text"  id="txtref_imput_presu" value="<?php echo $ref_imput_presu?>" size="15" readonly ></td>
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              ...
              <td width="200"><span class="Estilo5"><input class="Estilo10" name="txtsaldo_causado" type="text" id="txtsaldo_causado" size="25" style="text-align:right" maxlength="22"  value="<?php  echo $montocomp ?>" readonly>  </span> </td>
              <td width="125"><span class="Estilo5">MONTO A AJUSTAR :</span></td>
              <td width="167"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encende_monto(this)" onBlur="apaga_monto(this)" value="<?php  echo $monto ?>" size="25" maxlength="22" onKeypress="return validarNum(event)">
              </span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <table width="629" align="center">
          <tr>
            ...
            <td width="195"><input name="txtcredito" type="hidden" id="txtcredito" value="<?php  echo $credito?>" readonly></td>
            ...
            <td width="67"><input name="txtmonto_credito" type="hidden" id="txtmonto_credito" value="<?php  echo $montoc?>" readonly></td>
            <td width="85"><input name="txtcod_contable" type="hidden" id="txtcod_contable" value="<?php  echo $cod_contable?>" readonly></td>
            <td width="50"><input name="txtreferencia_comp" type="hidden" id="txtreferencia_comp" value="<?php  echo $ref_compromiso?>" readonly></td>
            <td width="50"><input name="txttipo_compromiso" type="hidden" id="txttipo_compromiso" value="<?php  echo $tipo_compromiso?>" readonly></td>
          </tr>
        </table>      </td>
    </tr>
  </table>
