...
var murl;
var r;
  murl="Esta seguro en Eliminar la Retenci�n de la Orden Financiera ?";
  r=confirm(murl);
  if(r==true){
    r=confirm("Esta Realmente seguro en Eliminar la Retenci�n de la Orden ?");
...
var Valido=true;
   ...
   if(f.txttipo_retencion.value==""){alert("Tipo de Reteneci�n no puede estar Vacio"); return false; }
