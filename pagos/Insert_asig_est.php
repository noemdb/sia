...
if (pg_last_error($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?php }
  ...
  if ($filas>0){$error=1; ?> <script language="JavaScript"> muestra('CEDULA YA EXISTE EN LA ESTRUCTURA');</script><?php }
      ...
      if ($filas==0){echo $sSQL;$error=1; ?> <script language="JavaScript"> muestra('REFERENCIA COMPROMISO NO EXISTE');</script><?php }
    }  
	...
	if($tipo_compromiso=="0000"){ $error=1; ?> <script language="JavaScript"> muestra('DOCUMENTO COMPROMISO INVALIDO'); </script><?php   }
