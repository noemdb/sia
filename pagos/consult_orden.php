...
if ($error==0){
  ...
  if ($filas==0){$error=1;?><script language="JavaScript">muestra('ORDEN DE PAGO NO EXISTE');</script><?php }
...
pg_close($conn); error_reporting(E_ALL ^ E_WARNING); if ($error==0){?><script language="JavaScript">document.location ='Act_orden_pago.php?Gcriterio=<?php  echo $nro_orden.$tipo_causado; ?>';</script> <?php }
