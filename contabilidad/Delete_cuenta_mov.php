...
if (pg_last_error($conn)) { ?>  <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if ($filas==0){?> <script language="JavaScript">  muestra('MOVIMIENTO NO LOCALIZADO'); </script>    <?php }
...
pg_close($conn);?><script language="JavaScript">document.location ='Det_inc_mov_comp.php?codigo_mov=<?php echo $codigo_mov?>';</script>