...
function llamar_eliminar(){var murl; var r;
  ...
  if(r==true){r=confirm("Esta Realmente seguro en Eliminar la Linea del Informe Contable ?");
    if(r==true){murl="Delete_campo_inf_contab.php?tipo_informe=<?php echo $tipo_informe?>&linea=<?php echo $linea?>"; document.location=murl;}}  else{url="Cancelado, no elimino";}
}
function llamar_calculable(){var murl; var minforme='<?php echo $tipo_informe?>'; var mlinea='<?php echo $linea?>'; var mcalculable=document.form1.txtcalculable.value;
        ...
        <tr>
          <td><table width="830" border="0">
              <tr>
                ...
                <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtlinea" type="text" id="txtlinea" size="10" maxlength="8" readonly  value="<?php echo $linea?>" > </span></td>
                <td width="120"><span class="Estilo5">CODIGO CUENTA :</span> </td>
				<td width="200"><span class="Estilo5"><input  class="Estilo10" name="txtCodigo_Cuenta" type="text" id="txtCodigo_Cuenta" class="Estilo5" value="<?php echo $codigo_cuenta?>" size="30" maxlength="30" onFocus="encender(this)" onBlur="apagar(this)" ></span></td>
                ...
                <td width="200"><span class="Estilo5"><input  class="Estilo10" name="txtcod_cuenta" type="text" class="Estilo5" id="txtcod_cuenta" value="<?php echo $cod_cuenta?>"  size="30" maxlength="30" onFocus="encender(this)" onBlur="apagar(this)">    </span></td>
              </tr>
          </table></td>
        </tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
            <td><table width="830">
                <tr>
                   ...
                   <td width="500"><span class="Estilo5"> <input  class="Estilo10" name="txtNombre_Cuenta" type="text" class="Estilo5" id="txtNombre_Cuenta" value="<?php echo $nombre_cuenta?>"  size="120" maxlength="200" onFocus="encender(this)" onBlur="apagar(this)">   </span></td>
                </tr>
            </table></td>
        </tr>
		<tr><td>&nbsp;</td></tr>
...
<script language="JavaScript" type="text/JavaScript"> 
var mcalculable='<?php echo $calculable;?>';
...
var mstatus_linea='<?php echo $status_linea;?>';  
...
var moperacion='<?php echo $moperacion;?>';
