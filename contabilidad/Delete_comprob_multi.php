<?php include ("../class/conect.php");  include ("../class/funciones.php"); include ("../class/configura.inc"); error_reporting(E_ALL); $Gtipo_pago="0005";
...
if (pg_last_error($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('COMPROBANTE CONTABLE NO EXISTE');</script><?php }
	 ...
	 if ($registro["modulo"]=="M"){$error=0;}else{$error=1; ?> <script language="JavaScript"> muestra('COMPROBANTE NO PUEDE SER ELIMINADO');</script><?php }
