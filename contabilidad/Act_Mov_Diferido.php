...
if (pg_last_error($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
      ...
      }$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> window.close();</script><?php } }
          ...
          <td><table width="466" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="225" align="center"><span class="Estilo5 Estilo11">HASTA :</span> <span class="Estilo5">
                <input name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_hoy?>" size="12" maxlength="10" onchange="checkrefechah(this.form)">
              </span></td>
              </tr>
          </table></td>
        </tr>
