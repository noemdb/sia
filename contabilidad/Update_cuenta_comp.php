...
if (pg_last_error($conn)) { ?>  <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script>  <?php }
  ...
  if ($filas==0){?> <script language="JavaScript">  muestra('CODIGO DE CUENTA NO EXISTE'); </script>    <?php }
     ...
     if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $error; ?>'); </script> <?php }
      else{?> <script language="JavaScript">  muestra('MODIFICO CUENTA DEL COMPROBANTE EXITOSAMENTE'); </script> <?php }
     }
  }
}
pg_close($conn);?><script language="JavaScript">document.location ='Det_inc_comprobantes.php?codigo_mov=<?php echo $codigo_mov?>';</script>