...
<?php }else{?><input name="txtreferencia_pago" type="text"  id="txtreferencia_pago" size="10" maxlength="8" onFocus="encender(this);" onBlur="apaga_referencia(this);"  onchange="checkreferencia(this.form);" value=<?php echo $ult_ref ?> >
<?php }pg_close($conn);?>