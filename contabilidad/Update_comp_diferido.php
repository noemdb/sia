<?php include ("../class/conect.php");  include ("../class/funciones.php"); $fecha_d=$_GET["fecha_d"];$fecha_h=$_GET["fecha_h"]; $url="Det_act_diferidos.php?fecha_d=".$fecha_d."&fecha_h=".$fecha_h;
...
if (pg_last_error($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if($i>0){?> <script language="JavaScript">  muestra('PROCESO FINALIZADO'); </script> <?php   
