<?php include ("../class/conect.php");  include ("../class/funciones.php");$codigo_mov=$_GET["codigo_mov"];
        ...
        <tr>
          <td><table width="614" border="0">
              <tr>
				...
				<td width="480"><span class="Estilo5"><input name="txtfecha" type="text" id="txtfecha" size="12" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);"  value="<?php echo $fecha_hoy?>" onchange="checkrefecha(this.form)">   </span></td>
             </tr>
          </table></td>
        </tr>
        <tr>
          ...
          <td><span class="Estilo5"> </span>
              <table width="614" border="0">
               <tr>
				 ...
				 <td width="150"><input name="txttipo_asiento" id="txttipo_asiento" size="5" maxlength="3" onFocus="encender(this)" onBlur="apagar(this)"   value="<?php echo $tipo_asiento?>" ></td>
