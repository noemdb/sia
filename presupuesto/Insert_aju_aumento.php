...
if ($error==0){ $sfecha=formato_aaaammdd($fecha_ajuste);  $rfecha=$sfecha;
  ...
  if($error==0){
    ...
    if ($filas==0){$error=1;?><script language="JavaScript">muestra('DOCUMENTO DE AJUSTE NO EXISTE');</script><?php }
        ...
        if($refierea==$registro["refierea"]){$error;} else{$error=1;?><script language="JavaScript">muestra('DOCUMENTO DE AJUSTE NO VALIDO');</script><?php }
      }}
    ...
    while(($registro=pg_fetch_array($res))and($error==0)){
      ...
      if($refierea=="CAUSADO"){
        ...
        if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('NO EXISTE EN EL CAUSADO EL CODIGO PRESUPUESTARIO:<?php  echo $registro["cod_presup"]; ?> FUENTE:<?php  echo $registro["fuente_financ"]; ?> REF.CREDITO:<?php  echo $registro["ref_imput_presu"]; ?>');</script><?php }
           ...
           $registro=pg_fetch_array($resultado);
           $compromiso=$registro["monto"]-$registro["pagado"]-$registro["ajustado"];
           if($monto_c>$compromiso){$error=1; ?> <script language="JavaScript"> muestra('MONTO A PAGAR MAYOR AL MONTO DEL CODIGO DEL CAUSADO POR AJUSTAR');</script><?php }
         }
      }
      if($refierea=="PAGO"){
        ...
        if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('NO EXISTE EN EL CAUSADO EL CODIGO PRESUPUESTARIO:<?php  echo $registro["cod_presup"]; ?> FUENTE:<?php  echo $registro["fuente_financ"]; ?> REF.CREDITO:<?php  echo $registro["ref_imput_presu"]; ?>');</script><?php }
           ...
           if($monto_c>$compromiso){$error=1; ?> <script language="JavaScript"> muestra('MONTO A PAGAR MAYOR AL MONTO DEL CODIGO DEL PAGO POR AJUSTAR');</script><?php }
         }
      }
    }
  ...
  if($error==0){
     ...
     if (!$resultado){?><script language="JavaScript"> muestra('<?php  echo $error; ?>');</script><?php  $error=1;}
       ...
       $error=0;?><script language="JavaScript">  muestra('INCLUYO EXITOSAMENTE');</script><?php 
