    ...
    if ($filas==0){$error=1;?>  <script language="JavaScript">  muestra('TIPO DE ASIENTO NO EXISTE');  </script>  <?php }
      ...
      if ($error==0){
         ...
         if (!$resultado){?><script language="JavaScript">muestra('<?php  echo $error; ?>');</script><?php }
           ...
           if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $error; ?>'); </script> <?php }
           ?><script language="JavaScript">muestra('INCLUYO EXITOSAMENTE');</script><?php }
      }
    }
 }
 pg_close($conn);
}
if ($error==0){?><script language="JavaScript">document.location ='Inc_comprobantes.php';</script> <?php }
