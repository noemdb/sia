 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
    <tr height="10">
      <td><table width="840" border="0" align="left">
        <tr>
		<!--
          <td width="168" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Codigo al Compromiso" onclick="javascript:LlamarURL('Inc_codigo_comp.php?codigo_mov=<?php echo $codigo_mov?>&cod_cat=<?php echo $cod_cat?>')"></td>
        -->
