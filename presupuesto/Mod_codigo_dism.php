  ...
  <table width="634" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="630" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">MODIFICAR Codigo DE LA DISMINUCI�N</span></td>
        </tr>
        <tr>
          ...
          <td><span class="Estilo5"> </span>
              <table width="620" border="0">
                <tr>
                  ...
                  <td width="190"><span class="Estilo5"><input class="Estilo10" name="txtdisponible" type="text" id="txtdisponible" size="25" style="text-align:right" value="<?php  echo $montod ?>" readonly>   </span>    </span></td>
                  <td width="109"><span class="Estilo5">MONTO </span>:</td>
                  <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" size="25" style="text-align:right" maxlength="22" value="<?php  echo $monto ?>" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)" >
                  </span></td>
                </tr>
            </table></td>
        </tr>
