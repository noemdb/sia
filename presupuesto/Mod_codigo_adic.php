        ...
        <tr>
          <td><table width="623" border="0">
            <tr>
              ...
              <td width="22"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuente" type="text" id="txtcod_fuente" value="<?php  echo $cod_fuente ?>" size="3" maxlength="2" readonly>   </span></td>
              <td width="17">&nbsp;</td>
              <td width="351"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuente" type="text" id="txtdes_fuente" value="<?php  echo $des_fuente ?>" size="50" readonly>   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="621" border="0">
              <tr>
                ...
                <td width="494"><span class="Estilo5"> <textarea name="txtdenominacion" class="Estilo10" cols="58" rows="2" readonly="readonly" id="txtdenominacion"><?php  echo $denominacion ?></textarea>
                </span></td>
              </tr>
            </table>            </td>
        </tr>
          ...
          <td><span class="Estilo5"> </span>
              <table width="620" border="0">
                <tr>
                  ...
                  <td width="190"><span class="Estilo5"><input class="Estilo10" name="txtdisponible" type="text" id="txtdisponible" size="25" style="text-align:right" value="<?php  echo $montod ?>" readonly></span></td>
                  <td width="109"><span class="Estilo5">MONTO </span>:</td>
                  <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" size="25" style="text-align:right" maxlength="22" value="<?php  echo $monto ?>" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)"></span></td>
                </tr>
            </table></td>
        </tr>
        <tr>
