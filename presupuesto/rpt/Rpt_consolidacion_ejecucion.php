        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="211"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_d?>" onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)"> </span></td>
              ...
              <td width="216"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_h?>"  onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)"></span></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="48"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" value="<?php echo $cod_fuente_d?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="2" size="5"  onkeypress="return stabular(event,this)">   </span></td>
        ...
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="533"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="60" maxlength="60" value="<?php echo $des_fuente_h?>" readonly onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="896" border="0">
            <tr>
              ...
              <td width="295"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad"  value="<?php echo $fecha_d?>" size="12" maxlength="12">  </span></td>
               <td width="66"><span class="Estilo5">HASTA : </span></td>
              <td width="211"><span class="Estilo12"><span class="Estilo5">
                <input class="Estilo10" name="txtFechah" type="text" id="txtFechah" size="12" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);"  value="<?php echo $fecha_h?>" onchange="checkrefecha(this.form)"  onkeypress="return stabular(event,this)">
