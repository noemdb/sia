...
if (pg_last_error($conn)){$error=1;?> <script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script> <?php } 
 ...
 $StrSQL = "DELETE FROM pre021 Where (tipo_registro='C') And (Nombre_Usuario='".$cod_mov."')";$res=pg_exec($conn,$StrSQL); $error=pg_errormessage($conn); $error=substr($error,0,91);  if (!$res){ ?> <script language="JavaScript">  muestra('<?php  echo $error; ?>'); </script> <?php }
        ...
        ?>
		   ...
		   <table border="0" cellspacing="0" cellpadding="0" align="left">
			 ...
			 <tr height="20">
				...
				<td width="100" align="left" ><strong></strong></td>
				<td width="100" align="left" ><strong></strong></td>
				<td width="400" align="center" > <font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><strong><?php 	echo $criterio2?></strong></font></td>
			 </tr>
			 <tr height="20">
		  ...
		  <?php 	$i=0; $total_monto=0; $total_ajuste=0; $total_monto_ajustado=0; $total_causado=0; $total_pagado=0; $sub_total_monto=0; $sub_total_ajuste=0; $sub_total_monto_ajustado=0; $sub_total_causado=0; $sub_total_pagado=0; $cantidad_ordenes=0; $prev_fecha_doc=""; $prev_referencia_comp="";  $prev_tipo_compromiso="";  $res=pg_query($sSQL);
		  $prev_ced_rif=""; $rtotal_monto=0; $rtotal_ajuste=0; $rtotal_monto_ajustado=0; $rtotal_causado=0; $rtotal_pagado=0; $rcantidad=0;
			...
			$nombre_abrev_comp=$registro["nombre_abrev_comp"]; $anulado=$registro["anulado"]; $nro_documento=$registro["nro_documento"]; $ced_rif=$registro["ced_rif"];   		   				$descripcion_doc=$registro["descripcion_doc"]; $nombre_benef=$registro["nombre_benef"]; $fecha_doc=formato_ddmmaaaa($fecha_doc); 
			     ...
			     ?>	 				 
				   <tr>
				    ...
				    <tr>
			           ...
			           <td width="100" align="right"><?php  echo $sub_total_ajuste; ?></td>
			           <td width="100" align="right"><?php  echo $sub_total_monto_ajustado; ?></td>
			           <td width="400" align="right"><?php  echo $sub_total_causado; ?></td>
				    ...
				    if($rcantidad>0){ 
						...
						?>	 				 
						   <tr>
							...
							<tr>
							   ...
							   <td width="100" align="right"><?php  echo $rtotal_monto; ?></td>
							   <td width="100" align="right"><?php  echo $rtotal_ajuste; ?></td>
							   <td width="100" align="right"><?php  echo $rtotal_monto_ajustado; ?></td>
							   <td width="400" align="right"><?php  echo $rtotal_causado; ?></td>
							   <td width="100" align="right"><?php  echo $rtotal_pagado; ?></td>
							</tr>		
							<tr>
							   <td width="100" align="left"></td>
							</tr>	
						...
						?>
							<tr>
							   ...
							   <td width="400" align="left"><?php  echo $ced_rif_grupo." ".$nombre_benef_grupo; ?></td>
							</tr>	
                        <?php 	
					$prev_ced_rif=$ced_rif_grupo; $rtotal_monto=0; $rtotal_ajuste=0; $rtotal_monto_ajustado=0; $rtotal_causado=0; $rtotal_pagado=0; $rcantidad=0;
				 }
			   ...
			   ?>	   
				<tr>
				   ...
				   <td width="100" align="right"><?php  echo $ajuste; ?></td>
				   <td width="100" align="right"><?php  echo $monto_ajus; ?></td>
				   <td width="400" align="right"><?php  echo $causado; ?></td>
		  ...
		  if(($sub_total_monto<>0)or($sub_total_ajuste>0)or($sub_total_monto_ajustado>0)or($sub_total_causado>0)or($sub_total_pagado>0)){ $sub_total_monto=formato_monto($sub_total_monto); $sub_total_ajuste=formato_monto($sub_total_ajuste); $sub_total_ajustado=formato_monto($sub_total_ajustado); $sub_total_monto_ajustado=formato_monto($sub_total_monto_ajustado); $sub_total_causado=formato_monto($sub_total_causado);$sub_total_pagado=formato_monto($sub_total_pagado);	
			...
			<tr>
			    ...
			    <td width="100" align="right"><strong><?php  echo $total_ajuste; ?></strong></td>
			    <td width="100" align="right"><strong><?php  echo $total_monto_ajustado; ?></strong></td>
			    <td width="400" align="right"><strong><?php  echo $total_causado; ?></strong></td>
