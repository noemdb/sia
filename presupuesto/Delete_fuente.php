<?php include ("../class/conect.php");  include ("../class/funciones.php"); $cod_fuente=$_GET["Gfuente"];$den_fuente="";$tipo="I";$afecta="S";
...
pg_close($conn); if ($error==0){?><script language="JavaScript">document.location ='Act_fuentes.php';</script> <?php } else {?>  <script language="JavaScript">history.back();</script> <?php }?>