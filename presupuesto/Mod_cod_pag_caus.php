...
function llamar_anterior(){document.location ='Det_inc_pagos_caus.php?codigo_mov=<?php echo $codigo_mov?>';}
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              ...
              <td width="167"><span class="Estilo5"> <input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<?php  echo $montocomp ?>" size="25" maxlength="22" onKeypress="return validarNum(event)">
              </span></td>
            </tr>
          </table></td>
        </tr>
