...
if (pg_last_error($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." INIC "; ?>'); </script> <?php }
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." DIF "; ?>'); </script> <?php }
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." MOD "; ?>'); </script> <?php }
  ...
  if (!$resultado){ echo $merror; ?> <script language="JavaScript">  muestra('<?php  echo $merror." COMP "; ?>'); </script> <?php }
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." CAUS "; ?>'); </script> <?php }
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." PAG "; ?>'); </script> <?php }
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." AJU "; ?>'); </script> <?php }
  ...
  if (!$resultado){ echo $merror,"<br>"; ?> <script language="JavaScript">  muestra('<?php  echo $merror." CRED. ADIC "; ?>'); </script> <?php }
  if($a>0){   echo "ESPERE ACTUALIZANDO ASIGNACION INICIAL....","<br>";
    for ($i=$a-1; $i>=0; $i--) {$str_C = $MControl[$i]; $str_L = $MControl[$i+1];   //echo $MControl[$i];
        ...
        if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror; ?>'); </script> <?php }
    }
  }
  ...
  while($registro=pg_fetch_array($resultado)){$cod_presup=$registro["cod_presup"]; $cod_fuente=$registro["cod_fuente"];$disponible=$registro["disponible"]; $disp_diferida=$registro["disp_diferida"];
    if($registro["disponible"]<0){ echo "Disponible: ".$registro["disponible"]."Codigo: ".$cod_presup." ".$cod_fuente,"<br>"; ?> <script language="JavaScript"> muestra('Error en Disponibilidad del Codigo: <?php  echo $cod_presup; ?> Fuente: <?php  echo $cod_fuente; ?>' );</script><?php }
    else{if($registro["disp_diferida"]<0){  ?> <script language="JavaScript"> muestra('Error en Disponibilidad Diferida del Codigo: <?php  echo $cod_presup; ?> Fuente: <?php  echo $cod_fuente; ?>' );</script><?php } }
  }
  /*
  ...
  if (!$resultado){ ?> <script language="JavaScript">  muestra('<?php  echo $merror." METAS "; ?>'); </script> <?php }
  */
