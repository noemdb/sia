...
function llamar_anterior(){document.location ='Det_inc_compromisos_dife.php?codigo_mov=<?php echo $codigo_mov?>';}
      ...
      <td><table width="630" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="671" border="0">
            <tr>
              ...
              <td width="277"><span class="Estilo5"><input class="Estilo10" name="txtdisponible" type="text" id="txtdisponible" size="25" style="text-align:right" value="<?php  echo $montod ?>" readonly>   </span> </td>
              <td width="69"><span class="Estilo5">MONTO  : </span></td>
              <td width="184"><span class="Estilo5"> <input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)" value="<?php  echo $monto ?>" size="25" maxlength="22" > </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="670">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_credito" type="text" id="txtmonto_credito" size="25" style="text-align:right" maxlength="22" value="<?php  echo $montoc ?>" readonly>  </span></td>
            </tr>
          </table> </td>
        </tr>
        <tr>
        ...
        <table width="629" align="center">
          <tr>
			...
			<td width="15"><input name="txtmonto_presup" type="hidden" id="txtmonto_presup" value="<?php echo $monto_presup?>"></td>
            <td width="180">&nbsp;</td>
