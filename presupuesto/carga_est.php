...
<table width="10">
  <tr>
	 ...
	 <td width="5"><input name="txtfecha_ini" type="hidden" id="txtfecha_ini" value="<?php echo $fecha_d?>" ></td>
	 <td width="5"><input name="txtfecha_fin" type="hidden" id="txtfecha_fin" value="<?php echo $fecha_h?>" ></td>	 
	 ...
	 <td width="5"><input name="txtconcepto_r" type="hidden" id="txtconcepto_r" value="<?php echo $concepto_est?>"></td>
...
<?php pg_close($conn);
if ($error==0){?><script language="JavaScript">Llamar_Inc_Comp('<?php  echo $ref_comp; ?>');</script> <?php }
