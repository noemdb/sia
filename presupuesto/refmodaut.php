<?php  include ("../class/conect.php"); include ("../class/funciones.php");  $password=$_GET["password"];$user=$_GET["user"];$dbname=$_GET["dbname"];$corr_m=$_GET["corr_m"]; $nro_aut=$_GET["nro_aut"]; $ult_ref="00000001";$tipo_modif=$_GET["tipo_modif"];
...
<?php }else{?><input class="Estilo10" name="txtreferencia_modif" type="text"  id="txtreferencia_modif" size="12" onFocus="encender(this)" onBlur="apagar(this)"  onchange="checkreferencia(this.form)" value="<?php echo $ult_ref ?>" onKeypress="return stabular(event,this)">
<?php } pg_close($conn);?>