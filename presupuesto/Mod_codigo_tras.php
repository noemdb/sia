...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Modificar C�digos en el Diferido)</title>
        ...
        <tr>
          <td><table width="627" border="0">
              <tr>
                ...
                <td width="131"><span class="Estilo5"><input class="Estilo10" name="txtgrupo" type="text" id="txtgrupo" size="4" maxlength="2" readonly value="<?php echo $grupo?>" onkeypress="return stabular(event,this)"> </span></td>
                <td width="188"><span class="Estilo5">C&Oacute;DIGO PRESUPUESTARIO : </span></td>
                <td width="211"><span class="Estilo5"><input class="Estilo10" name="txtcod_presup" type="text" id="txtcod_presup" title="Registre el C&oacute;digo de la Cuenta" value="<?php  echo $cod_presup ?>"  size="32" maxlength="32" readonly onkeypress="return stabular(event,this)">   </span></td>
                <td width="20">&nbsp;</td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="623" border="0">
            <tr>
              ...
              <td width="22"><span class="Estilo5"> <input class="Estilo10" name="txtcod_fuente" type="text" id="txtcod_fuente" value="<?php  echo $cod_fuente ?>" size="3" maxlength="2" readonly onkeypress="return stabular(event,this)"> </span></td>
              <td width="17">&nbsp;</td>
              <td width="351"><span class="Estilo5"> <input class="Estilo10" name="txtdes_fuente" type="text" id="txtdes_fuente" value="<?php  echo $des_fuente ?>" size="50" readonly onkeypress="return stabular(event,this)">     </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="621" border="0">
              <tr>
                ...
                <td width="494"><span class="Estilo5"> <textarea name="txtdenominacion" class="Estilo10" cols="58" rows="2" readonly="readonly" id="txtdenominacion" onkeypress="return stabular(event,this)"><?php  echo $denominacion ?></textarea>
                </span></td>
              </tr>
            </table>            </td>
        </tr>
        <tr>
          <td><table width="593" border="0">
            <tr>
              ...
              <td width="233"><span class="Estilo5"> <input class="Estilo10" name="txtdisponible" type="text" id="txtdisponible" size="25" style="text-align:right" value="<?php  echo $montod ?>" readonly onkeypress="return stabular(event,this)"></span></td>
              <td width="91"><span class="Estilo5">OPERACI&Oacute;N :</span></td>
              <td width="168"><span class="Estilo5"><input class="Estilo10" name="txtoperacion" type="text" id="txtoperacion" size="3"  value="<?php echo $operacion?>" align="center" readonly onkeypress="return stabular(event,this)"></span></td>
            </tr>
          </table>                </td>
        </tr>
        <tr>
          <td><table width="614" border="0">
            <tr>
              ...
              <td width="496"><span class="Estilo5"> <input class="Estilo10" name="txtmonto" type="text" id="txtmonto" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<?php  echo $monto ?>" size="25" maxlength="22" style="text-align:right" onKeypress="return validarNum(event,this)" >
              </span></td>
            </tr>
          </table></td>
        </tr>
