...
?><select class="Estilo10" name="txtimpuesto" id="txtimpuesto" onFocus="encender(this)" onBlur="apaga_tasa(this)" onkeypress="return stabular(event,this)">  <?php 
...
<?php } }
if($mtasa==0){?><option value="<?php  echo $tasa;?>" selected><?php  echo $tasa;?></option><?php }
?></select><?php pg_close($conn);?>