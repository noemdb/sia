...
if (pg_last_error($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('CODIGO PRESUPUESTARIO NO EXISTE EN EL AJUSTE');</script><?php }
    ...
    if(($error==0)and($monto_c<0)){$error=1; ?> <script language="JavaScript"> muestra('MONTO CODIGO INVALIDO');</script><?php }  $monto_credito=0;
    ...
    if($error==0){
      ...
      if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('CODIGO NO EXISTE EN EL CAUSADO');</script><?php }
         ...
         if(($monto_c>$compromiso)and($balance>0.001)){$error=1; ?> <script language="JavaScript"> muestra('MONTO A AJUSTAR MAYOR AL SALDO DEL CAUSADO');</script><?php }
       }
    }
