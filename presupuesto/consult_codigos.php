...
pg_close($conn); error_reporting(E_ALL ^ E_WARNING); if ($error==0){?><script language="JavaScript">document.location ='Act_codigos.php?Gcodigo=<?php  echo $cod_fuente.$cod_presup; ?>';</script> <?php }
