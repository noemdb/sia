...
function llamar_anterior(){document.location ='Det_inc_ajustes_comp.php?codigo_mov=<?php echo $codigo_mov?>';}
      ...
      <td><table width="692" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              ...
              <td width="200"><span class="Estilo5"><input class="Estilo10" name="txtmonto_compromiso" type="text" id="txtmonto_compromiso" size="25" style="text-align:right" maxlength="22"  value="<?php  echo $montocomp ?>" readonly>  </span> </td>
              <td width="125"><span class="Estilo5">MONTO A AJUSTAR :</span></td>
              <td width="167"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<?php  echo $monto ?>" onKeypress="return validarNum(event)" size="25" maxlength="22" > </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <table width="629" align="center">
          <tr>
            ...
            <td width="185"><input name="txtcod_contable" type="hidden" id="txtcod_contable" value="<?php  echo $cod_contable?>" readonly></td>
          </tr>
        </table>      </td>
    </tr>
  </table>
