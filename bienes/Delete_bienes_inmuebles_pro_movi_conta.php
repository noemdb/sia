...
if (pg_last_error($conn)) { ?> <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1;?><script language="JavaScript">muestra('REFERENCIA DE MOVIMIENTO NO EXISTE');</script><?php }
  ...
  if ($error==0){ if($status=="D"){ $error=1;?><script language="JavaScript">muestra('MOVIMIENTO DEBE SER ELIMINADO POR DESINCORPORACION');</script><?php } }
  if ($error==0){ 
