<?php include ("../class/conect.php");  include ("../class/funciones.php");$cod_material=$_GET["Gcod_material"];  $equipo = getenv("COMPUTERNAME"); $minf_usuario = $equipo." ".date("d/m/y H:i a");
...
if (pg_last_error($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('LA EMPRESA NO EXISTE');</script> <?php }
