...
pg_close($conn);
?><input class="Estilo10" name="txtnum_descrip" type="text" id="txtnum_descrip" size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" value=<?php  echo $ult_ref ?> >
