<?php include ("../class/conect.php"); include ("../class/funciones.php"); $cod_empleado=$_GET["cod_empleado"];    $saldo_prestaciones=0;  $fecha_calculo="";
...
pg_close($conn); $saldo_prestaciones=formato_monto($saldo_prestaciones); ?>
<input class="Estilo10" name="txtsaldo_prestaciones" type="text" id="txtsaldo_prestaciones" size="13" maxlength="12"  style="text-align:right" value="<?php echo $saldo_prestaciones?>" readonly>