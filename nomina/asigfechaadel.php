...
pg_close($conn);$fecha_calculo=formato_ddmmaaaa($fecha_calculo);?>
<input class="Estilo10" name="txtfecha_calculo" type="text" id="txtfecha_calculo" size="10" maxlength="10"  value="<?php echo $fecha_calculo?>" readonly>