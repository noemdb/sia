...
function llamar_anterior(){ document.location ='Det_def_calendario.php?mes=<?php echo $mes?>&ano=<?php echo $ano?>&ini=N'; }
        ...
        <tr>
          <td><table width="660" border="0">
              <tr>
                ...
                <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtfecha" type="text" id="txtfecha" size="15" maxlength="15"  value="<?php echo $fechac?>" readonly ></span></td>
				<td width="50"><span class="Estilo5"> DIA :</span> </td>
                <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtdia" type="text" id="txtdia" size="15" maxlength="15"  value="<?php echo $campo_str1?>" readonly ></span></td>
		 ...
		 <tr> <td>&nbsp;</td> </tr>
<script language="JavaScript" type="text/JavaScript">
var mvalor='<?php echo $status_feriado;?>'; var f=document.form1; 
if(mvalor=="S"){document.form1.txtstatus_feriado.options[0].selected = true;}else{document.form1.txtstatus_feriado.options[1].selected = true;}
        ...
        <tr>
          <td><table width="660" border="0">
              <tr>
                ...
                <td width="534"><textarea name="txtobservacion" cols="70" class="Estilo10" onFocus="encender(this)" onBlur="apagar(this)" id="txtobservacion"><?php  echo $observacion ?></textarea></td>
              </tr>
           </table></td>
        </tr>
        ...
        <table width="540" align="center">
          <tr>
		    <td width="5"><input class="Estilo10" name="txtmes" type="hidden" id="txtmes" value="<?php echo $mes?>" ></td>
			<td width="5"><input class="Estilo10" name="txtano" type="hidden" id="txtano" value="<?php echo $ano?>" ></td>
		    <td width="5"><input class="Estilo10" name="txtcant_horas" type="hidden" id="txtcant_horas" value="<?php echo $cant_horas?>" ></td>
			<td width="5"><input class="Estilo10" name="txtcampo_num1" type="hidden" id="txtcampo_num1" value="<?php echo $campo_num1?>" ></td>
			<td width="5"><input class="Estilo10" name="txtstatus1" type="hidden" id="txtstatus1" value="<?php echo $status1?>" ></td>
            <td width="100">&nbsp;</td>
