<?php include ("../class/conect.php");  include ("../class/funciones.php"); if(!$_GET){$codigo_dep="";$codigo_cargo="";}else{$codigo_dep=$_GET["cod_dep"];$codigo_cargo=$_GET["cod_cargo"];}?>
...
var murl; var r;
  ...
  if(r==true){r=confirm("Esta Realmente seguro en Eliminar el Cargo del Departamento ?");
    if(r==true){murl="Delete_cargo_dep.php?cod_dep=<?php echo $codigo_dep?>&cod_cargo=<?php echo $codigo_cargo?>"; document.location=murl;}}
        ...
        <tr>
          <td><table width="680" border="0">
              <tr>
                ...
                <td width="547"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_cargo" type="text" id="txtcodigo_cargo" size="15" maxlength="10"  value="<?php echo $codigo_cargo?>"  readonly></span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="680" border="0">
              <tr>
                ...
                <td width="546"><span class="Estilo5"><input class="Estilo10" name="txtdenominacion" type="text" id="txtdenominacion" size="75" maxlength="80" value="<?php echo $denominacion?>"  readonly ></span></td>
              </tr>
           </table></td>
        </tr>
        <tr>
          <td><table width="680" border="0">
              <tr>
                ...
                <td width="140"><span class="Estilo5"><input class="Estilo10" name="txtcod_tipo_personal" type="text" id="txtcod_tipo_personal" size="10" maxlength="5"  value="<?php echo $cod_tipo_personal?>"  onFocus="encender(this)" onBlur="apagar(this)"></span></td>
        ...
        <tr>
          <td><table width="680" border="0">
              <tr>
                ...
                <td width="546"><span class="Estilo5"><input class="Estilo10" name="txtdes_tipo_personal" type="text" id="txtdes_tipo_personal" size="75" maxlength="80" readonly value="<?php echo $des_tipo_personal?>"  ></span></td>
               </tr>
           </table></td>
        </tr>
        <tr>
             <td><table width="680">
               <tr>
                 ...
                 <td width="547" ><span class="Estilo5"><input class="Estilo10" name="txtnro_cargos" type="text" id="txtnro_cargos" size="5" maxlength="5" align="right" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $nro_cargos?>" ></span></td>
               </tr>
             </table></td>
           </tr>
        <tr>
