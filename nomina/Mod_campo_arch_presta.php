...
function llamar_anterior(){ document.location ='Det_inc_archivo_presta.php?criterio=<?php echo $tipo_arch_banco.$cod_arch_banco?>'; }
function llamar_eliminar(){var murl; var r;
  ...
  if(r==true){r=confirm("Esta Realmente seguro en Eliminar campo del Archivo ?");
    if(r==true){murl="Delete_campo_arch_presta.php?cod_arch_banco=<?php echo $cod_arch_banco?>&pos_campo=<?php echo $pos_campo?>&tipo_arch_banco=<?php echo $tipo_arch_banco?>"; document.location=murl;}}  else{url="Cancelado, no elimino";}
}
