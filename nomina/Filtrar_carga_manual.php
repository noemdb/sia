              ...
              <td>
                <table width="760">
                  <tr>
                    ...
                    <td width="600"><span class="Estilo5"><select name="txtopcion" size="1" id="txtopcion"
                          onFocus="encender(this)" onBlur="apagar(this)">
                          <option>QUITAR FILTRO</option>
              ...
              <td>
                <table width="760">
                  <tr>
                    ...
                    <td width="600"><span class="Estilo5"><input name="txtfiltro" type="text" id="txtfiltro" size="40"
                          maxlength="40" onFocus="encender(this)" onBlur="apagar(this)"> </span></td>
                  </tr>
                </table>
              </td>
            </tr>
