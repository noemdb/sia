...
pg_close($conn);if($error==0){?><script language="JavaScript"> alert('PROCESO TERMINADO'); window.close(); window.opener.location.reload(); </script> <?php }else{?><script language="JavaScript">history.back();</script><?php }?>
