...
if (pg_last_error($conn)) { ?>  <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if ($filas==0){ $error=1; ?>  <script language="JavaScript">  muestra('TIPO DE NOMINA NO EXISTE EN LA DEFINCION DE ARCHIVO');  </script> <?php }
...
}pg_close($conn); ?><script language="JavaScript">document.location ='<?php  echo $url; ?>';</script>
