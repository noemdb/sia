...
function llamar_anterior(){ document.location ='Det_condicion_arch_banco.php?cod_arch_banco=<?php echo $cod_arch_banco?>&pos_campo=<?php echo $pos_campo?>&tipo_arch_banco=<?php echo $tipo_arch_banco?>'; }
...
function llamar_eliminar(){var murl; var r;
  ...
  if(r==true){r=confirm("Esta Realmente seguro en Eliminar la Condicion del Campo ?");
    if(r==true){murl="Delete_cond_arch_banco.php?cod_arch_banco=<?php echo $cod_arch_banco?>&pos_campo=<?php echo $pos_campo?>&tipo_arch_banco=<?php echo $tipo_arch_banco?>&cod_condicion=<?php echo $cod_condicion?>"; document.location=murl;}}  else{url="Cancelado, no elimino";}
}
        ...
        <tr>
          <td><table width="830" border="0">
              <tr>
                ...
                <td width="700"><span class="Estilo5"><input class="Estilo10" name="txtsvalor_evaluar" type="text" id="txtsvalor_evaluar" size="90" maxlength="100" onFocus="encender(this)" onBlur="apagar(this)"  value="<?php echo $svalor_evaluar?>" > </span></td>
              </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        ...
        <tr>
          <td><table width="830" border="0">
              <tr>
                ...
                <td width="700"><span class="Estilo5"><input class="Estilo10" name="txtsvalor_retornar" type="text" id="txtsvalor_retornar" size="90" maxlength="100" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $svalor_retornar?>" > </span></td>
              </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
...
<script language="JavaScript" type="text/JavaScript"> 
var mcond_eval='<?php echo $condicion_evaluar;?>';  
        ...
        <table width="540" align="center">
          <tr>
           <td width="20"><input name="txtcod_arch_banco" type="hidden" id="txtcod_arch_banco" value="<?php echo $cod_arch_banco?>"></td>
			...
			<td width="20"><input name="txtpos_campo" type="hidden" id="txtpos_campo" value="<?php echo $pos_campo?>"></td>
			<td width="20"><input name="txtcod_condicion" type="hidden" id="txtcod_condicion" value="<?php echo $cod_condicion?>"></td>
            <td width="20">&nbsp;</td>
