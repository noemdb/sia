...
<?php  while($registro=pg_fetch_array($res)){$sfecha=$registro["fecha_desde_le"]; $fechad=formato_ddmmaaaa($sfecha); $sfecha=$registro["fecha_hasta_le"]; $fechah=formato_ddmmaaaa($sfecha); $monto_s=formato_monto($registro["sueldo_le"]);
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="80" align="left"><?php  echo $fechad; ?></td>
           <td width="80" align="left"><?php  echo $fechah; ?></td>
           <td width="200" align="left"><?php  echo $registro["empresa_le"]; ?></td>
           <td width="200" align="left"><?php  echo $registro["departamento_le"]; ?></td>
           <td width="180" align="left"><?php  echo $registro["cargo_le"]; ?></td>
