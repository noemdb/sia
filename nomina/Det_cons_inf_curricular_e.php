...
<?php  while($registro=pg_fetch_array($res)){$sfecha=$registro["fecha_ce"]; $fechac=formato_ddmmaaaa($sfecha);
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="50" align="left"><?php  echo $fechac; ?></td>
           <td width="110" align="left"><?php  echo $registro["titulo_ce"]; ?></td>
           <td width="150" align="left"><?php  echo $registro["instituto_ce"]; ?></td>
           <td width="250" align="left"><?php  echo $registro["descripcion_ce"]; ?></td>
           </tr>
         <?php }?>
       </table></td>
   </tr>
