 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Informaci&oacute;n Curricular" onclick="javascript:LlamarURL('Inc_inf_curr_e.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
