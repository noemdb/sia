...
return true;}
function llamar_anterior(){ document.location ='Det_conc_hist_nom.php?cod_empleado=<?php echo $cod_empleado?>&tipo_nomina=<?php echo $tipo_nomina?>&fecha_nomina=<?php echo $fechab?>'; }
    ...
    <tr>
      <td><table width="660" border="0" cellpadding="0" cellspacing="0">
           ...
           <tr>
             <td><table width="866">
                 <tr>
                   ...
                   <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtcod_concepto" type="text" id="txtcod_concepto" size="4" maxlength="4" readonly value="<?php echo $cod_concepto?>"> </span></td>
                   <td width="620"><span class="Estilo5"> <input class="Estilo10" name="txtdenominacion" type="text" id="txtdenominacion" size="80" maxlength="80" readonly value="<?php echo $denominacion?>"> </span></td>
                 </tr>
             </table></td>
           </tr>
		   <tr> <td>&nbsp;</td> </tr>
           ...
           <tr>
             <td><table width="760">
                 <tr>
                   ...
                   <td width="260"><span class="Estilo5"><input class="Estilo10" name="txtmonto_a" type="text" id="txtmonto_a" style="text-align:right" size="14" maxlength="14" readonly value="<?php echo $monto?>" onKeypress="return validarNum(event,this)" > </span></td>
        ...
        <table width="540" align="center">
          <tr>
            <td width="20"><input class="Estilo10" name="txtfecha_p_hasta" type="hidden" id="txtfecha_p_hasta" value="<?php echo $fecha_h?>"></td>
            <td width="20"><input class="Estilo10" name="txttp_calculo" type="hidden" id="txttp_calculo" value="<?php echo $tp_calculo?>"></td>
