<?php include ("../class/conect.php");  include ("../class/funciones.php"); $cod_tipo_per=$_GET["cod_tipo_per"]; $grado=$_GET["grado"]; $paso=$_GET["paso"];  
...
?>
<input class="Estilo10" name="txtcompensacion" type="text" id="txtcompensacion" size="16" maxlength="16" style="text-align:right" onFocus="encender_monto(this)" onBlur="apaga_monto(this)" value="<?php  echo $monto_compen;?>"  onKeypress="return validarNum(event)">
