...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="59" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="159" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
		   <td width="39" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="68" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="66" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="46" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="57" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="57" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
		   <td width="66" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="88" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="83" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
		   <td width="154" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
         </tr>
         <?php }
