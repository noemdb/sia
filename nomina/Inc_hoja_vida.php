        ...
        <tr>
          <td><table width="660" border="0">
              <tr>
                ...
                <td width="534"><span class="Estilo5"><input class="Estilo10" name="txtfecha" type="text" id="txtfecha" size="15" maxlength="15"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_hoy?>"></span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
