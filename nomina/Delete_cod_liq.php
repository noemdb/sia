<?php include ("../class/conect.php");  include ("../class/funciones.php"); error_reporting(E_ALL); $equipo = getenv("COMPUTERNAME"); $mcod_m="LIQ".$usuario_sia.$equipo; $fecha=asigna_fecha_hoy();
...
if (pg_last_error($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?php }
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('CODIGO CONCEPTO NO EXISTE EN LA LIQUIDACION');</script><?php }
