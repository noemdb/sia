<?php include ("../class/conect.php"); include ("../class/funciones.php");  $tipo_nomina=$_GET["tipo_nomina"]; $tp_calculo=$_GET["tp_calculo"]; $num_periodos=$_GET["num_periodos"]; $codigo_mov=$_GET["codigo_mov"]; $password=$_GET["password"]; $user=$_GET["user"];$dbname=$_GET["dbname"]; $fecha_desde=""; $fecha_hasta="";
...
<table width="946"><tr>
 ...
 <td width="250"><span class="Estilo5"><input class="Estilo10" name="txtfecha_desde" type="text" id="txtfecha_desde"  size="10" maxlength="10" readonly value="<?php echo $fecha_desde?>"> </span></td>
 <td width="190"><span class="Estilo5">FECHA PROCESO HASTA : </span></td>
 <td width="250"><span class="Estilo5"> <input class="Estilo10" name="txtfecha_hasta" type="text" id="txtfecha_hasta"  size="10" maxlength="10" readonly value="<?php echo $fecha_hasta?>"> </span></td>
</tr> </table>