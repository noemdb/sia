 ...
 <table width="945" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="940" border="0" align="left">
          <tr>
            <td width="400" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Concepto a la Liquidacion" onclick="javascript:LlamarURL('Inc_concepto_liq.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
...
<?php $total=0; while($registro=pg_fetch_array($res)) { $cantidad=$registro["cantidad"]; $monto=$registro["monto_orig"]; $total=$registro["valor"]; 
...
?>
        <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Modificar('<?php  echo $codigo_mov; ?>','<?php  echo $registro["cod_concepto"]; ?>'); " >
           <td width="40" align="left"><?php  echo $registro["cod_concepto"]; ?></td>
           <td width="450" align="left"><?php  echo $registro["denominacion"]; ?></td>
		   <td width="30" align="center"><?php  echo $registro["asig_ded_apo"]; ?></td>
           <td width="70" align="right"><?php  echo $cantidad; ?></td>
		   <td width="100" align="right"><?php  echo $monto; ?></td>
		   <td width="100" align="right"><?php  echo $total; ?></td>
		   <td width="70" align="center"><?php  echo $fecha1; ?></td>
		    <td width="70" align="center"><?php  echo $fecha2; ?></td>
          </tr>
     ...
     <td><table width="902" border="0">
       <tr>                
         ...
         <td width="155"><table width="130" border="1" cellspacing="0" cellpadding="0">
             <tr> <td align="right" class="Estilo5"><?php  echo $t_asina; ?></td></tr></table></td>
         <td width="86"><span class="Estilo5">DEDUCCION :</span></td>
         <td width="155"><table width="130" border="1" cellspacing="0" cellpadding="0">
             <tr> <td align="right" class="Estilo5"><?php  echo $t_deducc; ?></td> </tr> </table></td>
         ...
         <td width="141"><table width="130" border="1" cellspacing="0" cellpadding="0">
            <tr> <td align="right" class="Estilo5"><?php  echo $neto; ?></td></tr></table></td>		 
		 <td width="183"></td> 
       </tr>
     </table></td>
   </tr>
