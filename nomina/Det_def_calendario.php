...
$resg=pg_exec($conn,$sqlg);  $errorg=pg_errormessage($conn);$errorg=substr($errorg, 0, 91); if (!$resg){ ?> <script language="Javascript">  muestra('<?php  echo $errorg; ?>'); </script> <?php }
}
}
...
<table width="500" border="1" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr><td align="center" class="estiloe"><?php echo $des_mes; ?></td></tr>
   <tr>  
     ...
     <?php  $p=0; for ( $i=1;$i<=$semana;$i++ ) { $dia1=$calendar[$i][1]; $dia2=$calendar[$i][2]; $dia3=$calendar[$i][3]; $dia4=$calendar[$i][4]; $dia5=$calendar[$i][5]; $dia6=$calendar[$i][6]; $dia7=$calendar[$i][7]; 
    ...
    <tr>
       ...
       <table width="500"  border="0" cellspacing='0' cellpadding='0' align="center" id="ret_estructura">
         <tr height="20" class="Estilo5">
		   <td width="70" align="center" class="<?php  echo $estilodia1; ?>"><?php  echo $dia1; ?></td>
		   <td width="70" align="center" class="<?php  echo $estilodia2; ?>"><?php  echo $dia2; ?></td>
		   <td width="70" align="center" class="<?php  echo $estilodia3; ?>"><?php  echo $dia3; ?></td>
		   <td width="70" align="center" class="<?php  echo $estilodia4; ?>"><?php  echo $dia4; ?></td>
		   <td width="70" align="center" class="<?php  echo $estilodia5; ?>"><?php  echo $dia5; ?></td>
		   <td width="70" align="center" class="<?php  echo $estilodia6; ?>"><?php  echo $dia6; ?></td>
           <td width="70" align="center" class="<?php  echo $estilodia7; ?>"><?php  echo $dia7; ?></td>
         </tr>
		 </table>
	    </td>
	</tr>  
    ...
    <tr><td>&nbsp;</td></tr>
     <tr>   <td width="600">
       <table width="690"  border="1" cellspacing='0' cellpadding='0' align="center" id="ret_estructura">
         ...
         <?php  $sql="select * FROM nom049 Where (mes='$mes') and (ano='$ano') order by fecha_c"; $res=pg_query($sql);
while($registro=pg_fetch_array($res)){
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:llamar_seleccion('<?php  echo $registro["fecha_c"]; ?>');" >
           <td width="100" align="center"><?php  echo formato_ddmmaaaa($registro["fecha_c"]); ?></td>
		   <td width="100" align="center"><?php  echo $registro["campo_str1"]; ?></td>
		   <td width="100" align="center"><?php  echo $registro["status_feriado"]; ?></td>
           <?php  if ($registro["des_feriado"]=="") {?><td width="540" align="left">&nbsp;</td>
           <?php }else{?> <td width="390" align="left"><?php  echo $registro["des_feriado"]; ?></td> <?php }?>
...
function llamar_seleccion(mfecha_c){ var mmes='<?php  echo $mes; ?>'; var mano='<?php  echo $ano; ?>';
