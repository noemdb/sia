   ...
   <tr>
          <td><table width="600">
            <tr>
              ...
              <td width="150"><input class="Estilo10" name="txttp_calculo" type="text"  id="txttp_calculo" size="15" maxlength="10" value="<?php  echo $dtp_calculo ?>" readonly  ></td>
              <td width="180"><span class="Estilo5">FECHA PROCESO HASTA :</span></td>
			  <td width="140"><input class="Estilo10" name="txtfecha_p_hasta" type="text"  id="txtfecha_p_hasta" size="11" maxlength="11" value="<?php  echo $tfecha_p_hasta ?>" readonly  ></td>
             </tr>
          </table></td>
        </tr>
   <tr>
...
?>
       <table width="600"  border="1" cellspacing='0' cellpadding='0' align="left" id="ctas_pasivo">
         ...
         <?php  while($registro=pg_fetch_array($res)){  $cod_concepto=$registro["cod_concepto"]; $asig_ded_apo=$registro["asig_ded_apo"]; $monto=$registro["monto"];
         ...
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="80" align="center"><?php  echo $cod_concepto; ?></td>
		   <td width="260" align="left"><?php  echo $denominacion; ?></td>
		   <td width="120" align="right"><?php  echo $masigna; ?></td>
		   <td width="120" align="right"><?php  echo $mdeduc; ?></td>           
         </tr>
         <?php }?>
       </table></td>
   </tr>
