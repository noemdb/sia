	  ...
	  while($registro=pg_fetch_array($res)){ $i=$i+1; $cod_emp=$registro["cod_empleado"]; $tipo_nom=$registro["tipo_nomina"];	$cod_cat=$registro["cod_categ"];	
		if(($prev_cod_empleado<>$cod_emp)or($prev_cod_cat<>$cod_cat)){ $cant_emp=$cant_emp+1;
			...
			if( $prev_cod_cat<>$cod_cat){
		      ...
		      <tr>
				  <td width="100" align="left"></td>
				  <td width="400" align="left"><?php  echo $prev_cod_cat.'  '.$nomb_cat ?></td>	                  
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $sub_tot1; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $sub_tot2; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $sub_tot3; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $sub_tot4; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $sub_tot5; ?></td>
			  </tr>
			  <tr height="20">
		      </tr>
		      <?php 
