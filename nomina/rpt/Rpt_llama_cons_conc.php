...
if (pg_last_error($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  else{ $error=1; echo "Codigo: ".$codigo_rpt; ?> <script language="JavaScript">muestra('CODIGO REPORTES NO LOCALIZADO');</script><?php }  
...
pg_close($conn); if($error==0){?><script language="JavaScript">document.location ='<?php  echo $url; ?>';</script><?php }?>
