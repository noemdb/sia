  ...
  $sSQL = "SELECT *  FROM ".$criterio."  and (tipo_nomina>='".$tipo_nomina_d."' and tipo_nomina<='".$tipo_nomina_h."') and
	  ...
	  ?>
	   <table border="0" cellspacing='0' cellpadding='0' align="left">
		 ...
		 <tr height="20">
		    <td width="100" align="left" ><strong><?php  echo "Mes : ".$mesh; ?></strong></td>
			<td width="400" align="left" ><strong><?php  echo " Año: ".$mano; ?></strong></td>
		 </tr>
		 <tr height="20">
		...
		<?php   $tot1=0; $tot2=0; $tot3=0; $tot4=0; $tot5=0; $tot6=0; $tot7=0; $tot8=0; $tot9=0; $tot10=0; $tot11=0; $tot12=0; $tot13=0; $tot14=0; $tot15=0; $tot16=0; $tot17=0; $tot18=0; $tot19=0; $tot20=0;
		   ...
		   if($prev_cod_empleado<>$cod_emp){ $cant_emp=$cant_emp+1;
		    ...
		    ?>
		      <tr>
                  ...
                  <td width="100" align="left"><?php  echo $fechai; ?></td>		
                  <td width="100" align="left"><?php  echo $cod_cargo; ?></td>	
                  <td width="200" align="left"><?php  echo $des_cargo; ?></td>	
                  <td width="100" align="left"><?php  echo $cod_departam; ?></td>	
                  <td width="200" align="left"><?php  echo $des_departam; ?></td>	
                  <td width="200" align="left"><?php  echo $cod_presup; ?></td>	
				  ...
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc9; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc10; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc11; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc12; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc13; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc14; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc15; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc16; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc17; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc18; ?></td>
				  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $conc19; ?></td>
				  
			  </tr>
		    <?php  $prev_cod_empleado=$cod_emp;
			$conc1=0; $conc2=0; $conc3=0; $conc4=0; $conc5=0; $conc6=0; $conc7=0; $conc8=0; $conc9=0; $conc10=0; $conc11=0; $conc12=0; $conc13=0; $conc14=0; $conc15=0; $conc16=0; $conc17=0; $conc18=0; $conc19=0; $conc20=0;
		  }
		...
		<tr>
		  <td width="100" align="left"></td>
		  <td width="400" align="left"><?php  echo "Nro. Trabjadores : ".$cant_emp; ?></td>
		  <td width="100" align="left"></td>
		  <td width="100" align="left"></td>
		  <td width="200" align="left"></td>
		  <td width="100" align="left"></td>
		  <td width="200" align="left"></td>
		  <td width="200" align="right"><?php  echo "TOTAL  : "; ?></td>
		  
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot1; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot2; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot3; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot4; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot5; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot6; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot7; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot8; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot9; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot10; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot11; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot12; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot13; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot14; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot15; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot16; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot17; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot18; ?></td>
		  <td width="100" align="right" style="mso-number-format:'#,###,##0.00';"><?php  echo $tot19; ?></td>
		</tr>	
