             ...
             <td><table width="905">
               <tr>
                 ...
                 <td width="137" scope="col"><span class="Estilo5"><span class="Estilo10">
                   <input name="txtcod_empleado_h" type="text" id="txtcod_empleado_h" onFocus="encender(this)" onBlur="apagar(this)" size="20" maxlength="20" value="<?php echo $cod_empleado_d?>">
