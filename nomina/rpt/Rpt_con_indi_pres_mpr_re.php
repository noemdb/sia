...
<?php   $nombre_d="";$nombre_h=""; $descripcion_d=""; $descripcion_h="";   
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="725"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
