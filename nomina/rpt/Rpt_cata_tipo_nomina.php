           ...
           <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr>
                 ...
                 <td width="43"><div align="left"><span class="Estilo5"> <input class="Estilo10" name="txttipo_nomina_d" type="text" id="txttipo_nomina_d" onFocus="encender(this)" onBlur="apagar(this)" size="2" maxlength="2" value="<?php echo $tipo_nomina_d?>" class="Estilo5"> </span></div></td>
                 ...
                 <td width="679"><div align="left"><span class="Estilo5"> <input class="Estilo10" name="txtdescripcion_d" type="text" id="txtdescripcion_d" size="100" maxlength="108" value="<?php echo $descripcion_d?>" readonly class="Estilo5" > </span></div></td>
               </tr>
             </table></td>
           </tr>
           <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0">
             <tr>
               ...
               <td width="43"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txttipo_nomina_h" type="text" id="txttipo_nomina_h" onFocus="encender(this)" onBlur="apagar(this)" size="2" maxlength="2" value="<?php echo $tipo_nomina_h?>" class="Estilo5"> </span></div></td>
               ...
               <td width="679" align="center"><div align="left"><span class="Estilo5"> <input class="Estilo10" name="txtdescripcion_h" type="text" id="txtdescripcion_h" size="100" maxlength="109" value="<?php echo $descripcion_h?>" readonly class="Estilo5">   </span></div></td>
             </tr>
           </table></td>
           </tr>
           <tr><td>&nbsp;</td></tr>	
