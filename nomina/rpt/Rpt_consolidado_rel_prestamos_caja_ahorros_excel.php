   ...
   $sSQL = "SELECT *  FROM ".$criterio."  and (tipo_nomina>='".$tipo_nomina_d."' and tipo_nomina<='".$tipo_nomina_h."') and
	  ...
	  ?>
	   <table border="0" cellspacing='0' cellpadding='0' align="left">
		 ...
		 <?php if($tipo_nomina_d==$tipo_nomina_h){ ?>
		 <tr height="20">
		 ...
		 <?php }else{ ?>
		  <tr height="20">
		     <td width="100" align="left" ><strong></strong></td>
		     <td width="400" align="left" ><strong><?php  echo $criterio3; ?></strong></td>
		 </tr>
		 <?php } ?>
		 <tr height="20">
		    <td width="100" align="left" ><strong></strong></td>
			<td width="400" align="left" ><strong><?php  echo $criterio1; ?></strong></td>
		 </tr>
		 <tr height="20">
		 </tr>
		 <tr height="20">
	  ...
	  $tot1=$tot1+$conc1; $tot2=$tot2+$conc2; $tot3=$tot3+$conc3; $tot4=$tot4+$conc4; $tot5=$tot5+$conc5; $tot6=$tot6+$conc6; $tot7=$tot7+$conc7; $tot8=$tot8+$conc8; $tot9=$tot9+$conc9; 
		...
		?>
		  ...
		  <tr>
		      <td width="100" align="left"> </td>
			  <td width="400" align="left">NRO.TRABAJADORES : <?php  echo $cant_emp; ?></td>
