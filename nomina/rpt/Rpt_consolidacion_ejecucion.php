...
<?php $formato_presup="XX-XX-XX-XXX-XX-XX-XX";  $formato_categoria="XX-XX-XX";  $formato_partida="XXX-XX-XX-XX";
        ...
        <tr>
          <td height="19"><table width="915" border="0">
            <tr>
              ...
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="35" maxlength="35" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_d?>" > </span></td>
              ...
              <td width="206"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="35" maxlength="35" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_h?>" ></span></td>
        ...
        <tr>
          <td height="19"><table width="896" border="0">
            <tr>
              ...
              <td width="295"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" readonly value="<?php echo $fecha_d?>" size="12" maxlength="12">  </span></td>
