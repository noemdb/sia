           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="30"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txttipo_nomina_d" type="text" id="txttipo_nomina_d" onFocus="encender(this)" onBlur="apaga_tipo(this)" size="2" maxlength="2" value="<?php echo $tipo_nomina_d?>"  onchange="chequea_tipo(this.form);">  </span></div></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="269"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
                  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario1" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></div></td>
                 <td width="56"><span class="Estilo5">HASTA :</span></td>
                 <td width="378"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="269"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtedad_d" type="text" id="txtedad_d" size="5" maxlength="15"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $edad_d?>"> </span></div></td>
                 <td width="56"><span class="Estilo5">HASTA :</span></td> <td width="378"><span class="Estilo5"><input class="Estilo10" name="txtedad_h" type="text" id="txtedad_h" size="5" maxlength="15"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $edad_h?>">   </span></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="272"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechaingresod" type="text" id="txtFechaingresod" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkfechaingd(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario9')"  />  </span></div></td>
                 ...
                 <td width="376"><span class="Estilo5"> <input class="Estilo10" name="txtFechaingresoh" type="text" id="txtFechaingresoh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkfechaingh(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="174"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_departamento_d" type="text" id="txtcodigo_departamento_d" onFocus="encender(this)" onBlur="apagar(this)" size="25" maxlength="25" value="<?php echo $codigo_departamento_d?>"> </span></div></td>
                 ...
                 <td width="56"><span class="Estilo5">HASTA :</span></td>
                 <td width="174"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_departamento_h" type="text" id="txtcodigo_departamento_h" onFocus="encender(this)" onBlur="apagar(this)" size="25" maxlength="25" value="<?php echo $codigo_departamento_h?>">  </span></td>
