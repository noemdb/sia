		...
		if($prev_cod_empleado<>$cod_emp){ $cant_emp=$cant_emp+1;
			...
			?>
		      <tr>
				  ...
				  <td width="100" align="left"><?php  echo $rif_empleado; ?></td>	
				  <td width="400" align="left"><?php  echo $nombre; ?></td>	
                             ...
                             <td width="100" align="center" style="mso-number-format:'@';"><?php  echo 'NA'; ?></td>	
	  ...
	  $tot1=$tot1+$conc1; $tot2=$tot2+$conc2; $tot3=$tot3+$conc3; $tot4=$tot4+$conc4; $tot5=$tot5+$conc5; $cant_emp=$cant_emp+1;
		...
		?>
		  ...
		  <tr>
			  ...
			  <td width="100" align="left"><?php  echo $cant_emp; ?></td>              
			  <td width="100" align="left"></td>
			  <td width="100" align="left"></td>
