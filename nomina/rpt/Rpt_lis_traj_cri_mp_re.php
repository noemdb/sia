		   ...
		   <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="30"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txttipo_nomina_d" type="text" id="txttipo_nomina_d" onFocus="encender(this)" onBlur="apagar(this)" size="2" maxlength="2" value="<?php echo $tipo_nomina_d?>">  </span></div></td>
                 ...
                 <td width="29"><span class="Estilo5"> <input class="Estilo10" name="txttipo_nomina_h" type="text" id="txttipo_nomina_h" onFocus="encender(this)" onBlur="apagar(this)" size="2" maxlength="2" value="<?php echo $tipo_nomina_h?>">  </span></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="142"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtcod_empleado_d" type="text" id="txtcod_empleado_d" onFocus="encender(this)" onBlur="apagar(this)" size="20" maxlength="15" value="<?php echo $cod_empleado_d?>">   </span></div></td>
                 ...
                 <td width="137"><span class="Estilo5"> <input class="Estilo10" name="txtcod_empleado_h" type="text" id="txtcod_empleado_h" onFocus="encender(this)" onBlur="apagar(this)" size="20" maxlength="20" value="<?php echo $cod_empleado_h?>"> </span></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="94"><div align="left"><span class="Estilo5"> <input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" size="12" maxlength="12" value="<?php echo $cedula_d?>">  </span></div></td>
                 ...
                 <td width="94"><span class="Estilo5"> <input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" size="12" maxlength="12" value="<?php echo $cedula_h?>">  </span></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="269"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
                  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario1" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></div></td>
                 <td width="56"><span class="Estilo5">HASTA :</span></td>
                 <td width="378"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
		   ...
		   <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="269"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtedad_d" type="text" id="txtedad_d" size="5" maxlength="5"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $edad_d?>"> </span></div></td>
                 <td width="56"><span class="Estilo5">HASTA :</span></td>
                 <td width="378"><span class="Estilo5"><input class="Estilo10" name="txtedad_h" type="text" id="txtedad_h" size="5" maxlength="5"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $edad_h?>">
                  </span></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="272"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechaingresod" type="text" id="txtFechaingresod" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkfechaingd(this.form)">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario9')"  />  </span></div></td>
                 ...
                 <td width="376"><span class="Estilo5"> <input class="Estilo10" name="txtFechaingresoh" type="text" id="txtFechaingresoh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkfechaingh(this.form)">
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="91"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_cargo_d" type="text" id="txtcodigo_cargo_d" onFocus="encender(this)" onBlur="apagar(this)" size="12" maxlength="12" value="<?php echo $codigo_cargo_d?>"> </span></div></td>
                 ...
                 <td width="57"><span class="Estilo5">HASTA :</span></td>
                 <td width="93"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_cargo_h" type="text" id="txtcodigo_cargo_h" onFocus="encender(this)" onBlur="apagar(this)" size="12" maxlength="12" value="<?php echo $codigo_cargo_h?>"> </span></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="174"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_departamento_d" type="text" id="txtcodigo_departamento_d" onFocus="encender(this)" onBlur="apagar(this)" size="20" maxlength="20" value="<?php echo $codigo_departamento_d?>"> </span></div></td>
                 ...
                 <td width="56"><span class="Estilo5">HASTA :</span></td>
                 <td width="174"><span class="Estilo5"><input class="Estilo10" name="txtcodigo_departamento_h" type="text" id="txtcodigo_departamento_h" onFocus="encender(this)" onBlur="apagar(this)" size="20" maxlength="20" value="<?php echo $codigo_departamento_h?>">  </span></td>
		   ...
		   <tr>
             <td><table width="905">
               <tr>
				...
				<td width="95"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txttipo_personal_d" type="text" id="txttipo_personal_d" onFocus="encender(this)" onBlur="apagar(this)" size="10" maxlength="10" value="<?php echo $tipo_personal_d?>"></span></div></td> 
				...
				<td width="56"><span class="Estilo5">HASTA :</span></td>                 
				<td width="94"><span class="Estilo5"><input class="Estilo10" name="txttipo_personal_h" type="text" id="txttipo_personal_h" onFocus="encender(this)" onBlur="apagar(this)" size="10" maxlength="10" value="<?php echo $tipo_personal_h?>"></span></span></td>
		   ...
		   <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="272"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechaegresod" type="text" id="txtFechaegresod" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkfechaegd(this.form)">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario11')"  />  </span></div></td>
                 <td width="57"><span class="Estilo5">HASTA :</span></td>
                 <td width="376"><span class="Estilo5"> <input class="Estilo10" name="txtFechaegresoh" type="text" id="txtFechaegresoh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkfechaegh(this.form)">
		   ...
		   <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="272"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechafincod" type="text" id="txtFechafincod" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkfechaegd(this.form)">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario13')"  />  </span></div></td>
                 <td width="57"><span class="Estilo5">HASTA :</span></td>
                 <td width="376"><span class="Estilo5"> <input class="Estilo10" name="txtFechafincoh" type="text" id="txtFechafincoh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkfechaegh(this.form)">
