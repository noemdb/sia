...
<?php   $descripcion_d=""; $descripcion_h=""; $nombre_empled=""; $nombre_empleh=""; $denominacion_cargod=""; $denominacion_cargoh="";$descripcion_dep_d=""; $descripcion_dep_h="";
           ...
           <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr>
                 ...
                 <td width="567" align="left"><span class="Estilo5"> <input class="Estilo10" name="txtdenominacion_d" type="text" id="txtdenominacion_d" size="70" maxlength="75" readonly value="<?php echo $denominacion_cargod?>">  </span></td>
               </tr>
             </table></td>
           </tr>
		   <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr>
                 ...
                 <td width="567" align="left"><span class="Estilo5"><input class="Estilo10" name="txtdenominacion_h" type="text" id="txtdenominacion_h" size="70" maxlength="75" readonly value="<?php echo $denominacion_cargoh?>">   </span></td>
               </tr>
             </table></td>
           </tr>		   
		   <tr>
		    ...
		    <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr>
                 ...
                 <td width="160" align="left"><span class="Estilo5"><input class="Estilo10" name="txtnum_recibo_d" type="text" id="txtnum_recibo_d" size="8" maxlength="5" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $num_rec_d?>"></span></td>
                 <td width="49" align="left"><span class="Estilo5">HASTA : </span></td>
                 <td width="499" align="left"><span class="Estilo5"><input class="Estilo10" name="txtnum_recibo_h" type="text" id="txtnum_recibo_h" size="8" maxlength="5" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $num_rec_h?>"> </span></td>
               </tr>
             </table></td>
           </tr>
		   <tr>
