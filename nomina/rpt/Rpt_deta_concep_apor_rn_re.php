...
<?php $descripcion_d="";$descripcion_h=""; $denominacion_concep_d="";$denominacion_concep_h="";  $descripcion_dep_d="";$descripcion_dep_d=""; $fecha_nomina=asigna_fecha_hoy();
           ...
           <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
				 ...
				 <td width="170" align="left"><span class="Estilo5"><input class="Estilo10" name="txtfecha_nom" type="text" id="txtfecha_nom" size="12" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_nomina?>" onchange="chequea_fecha(this);" onkeyup="mascara(this,'/',patronfecha,true)"></span></td>
