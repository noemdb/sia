        ...
        <tr>
          <td height="30"><table width="915" border="0">
            <tr>
              ...
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="35" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_d?>" > </span></td>
              ...
              <td width="206"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="35" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_h?>" ></span></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="470"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuented" type="text" id="txtdes_fuented" size="90" maxlength="90" value="<?php echo $des_fuente_d?>" readonly></span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="19">&nbsp;</td></tr>
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="530"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="90" maxlength="60" value="<?php echo $des_fuente_h?>" readonly></span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="19">&nbsp;</td></tr>
        <tr>
          <td height="19"><table width="492" border="0">
            <tr>
              ...
              <td width="240"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" readonly value="<?php echo $fecha_hoy?>" size="12" maxlength="10" > </span></td>
            </tr>
          </table></td>
        </tr>
		<tr><td height="19">&nbsp;</td></tr>
