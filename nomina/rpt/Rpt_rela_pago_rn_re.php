...
<?php $descripcion_d="";$descripcion_h=""; $descripcion_dep_d="";$descripcion_dep_d="";
           ...
           <tr>
             <td><table width="903">
               <tr>
				 ...
				 <td width="340" align="left"><span class="Estilo5"> <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_hoy?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
