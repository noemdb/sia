        ...
        <tr>
          <td height="30"><table width="813" border="0">
            <tr>
              ...
              <td width="221"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="35" maxlength="32" value="<?php echo $cod_presup_d?>" onFocus="encender(this); " onBlur="apagar(this);">  </span></td>
        ...
        <tr>
          <td height="30"><table width="827" border="0">
            <tr>
              ...
              <td width="222"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="35" maxlength="32" value="<?php echo $cod_presup_h?>" onFocus="encender(this); " onBlur="apagar(this);">    </span></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="62"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="5" value="<?php echo $cod_fuente_d?>">   </span></td>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="61"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuenteh" type="text" id="txtcod_fuenteh" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="5" value="<?php echo $cod_fuente_h?>">   </span></td>
