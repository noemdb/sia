<?php $gnomina="00"; include ("../../class/seguridad.inc");include ("../../class/conects.php");  include ("../../class/funciones.php"); include ("../../class/configura.inc");
   ...
   <td width="888" height="480"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
       ...
       <div id="Layer1" style="position:absolute; width:460px; height:94px; z-index:1; top: 60px; left: 42px;">
         <table width="828" border="0" align="center" >
		   ...
		   <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
                 ...
                 <td width="125" align="left" class="Estilo5"><input class="Estilo10" name="txtcod_presup_d" type="text" id="txtcod_presup_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cod_presup_catd?>" size="16" maxlength="20">  </td>
                 ...
                 <td width="125" align="left" class="Estilo5"><input class="Estilo10" name="txtcod_presup_h" type="text" id="txtcod_presup_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cod_presup_cath?>" size="16" maxlength="20"> </td>
           ...
           <tr><td>&nbsp;</td></tr>
		   <?php if(($Cod_Emp=="58")OR ($Cod_Emp=="A1")or($Cod_Emp=="A4")){?>
           <tr>
