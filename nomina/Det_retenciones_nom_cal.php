...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           ...
           <td width="200" align="center"><?php  echo $registro["cod_presup_ret"]; ?></td>
           <td width="50" align="center"><?php  echo $registro["fuente_fin_ret"]; ?></td>
           <td width="140" align="center"><?php  echo $registro["ced_rif_r"]; ?></td>
           <td width="80" align="center"><?php  echo $registro["ref_comp_ret"]; ?></td>
           <td width="50" align="center"><?php  echo $registro["tipo_comp_ret"]; ?></td>
          </tr>
         <?php }
