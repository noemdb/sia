...
function llamar_anterior(){ document.location ='Cat_conceptos_e.php?cod_arch_banco=<?php echo $cod_arch_banco?>'; }
  ...
  <table width="634" height="200" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <tr>
          <td><table width="620">
                 <tr>
                   ...
                   <td width="90"><span class="Estilo5"><input class="Estilo10" name="txtcod_concepto" type="text" id="txtcod_concepto" size="4" maxlength="3" onFocus="encender(this)" value="<?php echo $cod_concepto?>" onBlur="apagar(this)" onchange="chequea_concepto(this.form);"> </span></td>
                   <td width="360"><input class="Estilo10" name="btconcepto" type="button" id="btconcepto" title="Abrir Catalogo Conceptos"  onClick="VentanaCentrada('Cat_conceptos_sel.php?cod_arch_banco=<?php echo $cod_arch_banco;?>&criterio=','SIA','','750','500','true')" value="..."> </span></td>
                  </tr>
           </table></td>
        </tr>
        <tr> <td>&nbsp;</td> </tr>
        <tr>
          <td><table width="620">
            <tr>
              ...
              <td width="500"><span class="Estilo5"> <input class="Estilo10" name="txtdenominacion" type="text" id="txtdenominacion" size="75" maxlength="80" readonly  value="<?php echo $denominacion?>"></span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td><p>&nbsp;</p></td> </tr>
      ...
      <table width="540" align="center">
          <tr>
            <td width="17"><input class="Estilo10" name="txtcod_arch_banco" type="hidden" id="txtcod_arch_banco" value="<?php echo $cod_arch_banco?>"></td>
            <td width="100">&nbsp;</td>
