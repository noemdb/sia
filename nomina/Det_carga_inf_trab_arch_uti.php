...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="20" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="15" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
		   <td width="60" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="30" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
		   <td width="30" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="10" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
         </tr>
         <?php }
