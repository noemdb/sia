<?php include ("../class/conect.php");  include ("../class/funciones.php"); if (!$_GET){$cod_arch_banco='';}else{$cod_arch_banco=$_GET["cod_arch_banco"];}
 ...
 <table width="630" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="630" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="210" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Concepto a la Lista" onclick="javascript:LlamarURL('Inc_conceptos_e.php?cod_arch_banco=<?php echo $cod_arch_banco?>&cod_concepto=&denominacion=')"></td>
...
?>
       <table width="610"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_estructura">
         ...
         <?php  while($registro=pg_fetch_array($res)) { $denominacion=""; $cod_concepto=$registro["cod_concepto"]; 
        ...
        ?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Eliminar('<?php  echo $cod_arch_banco; ?>','<?php  echo $registro["cod_concepto"]; ?>');" >
