...
<?php $total=0; while($registro=pg_fetch_array($res)) { $cantidad=$registro["cantidad"]; $monto=$registro["valor"]; $cantidad=formato_monto($cantidad); $monto=formato_monto($monto);  
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];"  >
           <td width="100" align="left"><?php  echo formato_ddmmaaaa($registro["fecha_hasta"]); ?></td>           
           <td width="50" align="left"><?php  echo $registro["cod_concepto"]; ?></td>
           <td width="350" align="left"><?php  echo $registro["denominacion"]; ?></td>
		   <td width="40" align="center"><?php  echo $registro["asig_ded_apo"]; ?></td>
		   ...
		   <td width="50" align="center"><?php  echo $registro["afecta_presup"]; ?></td>
		   <td width="200" align="center"><?php  echo $registro["cod_presup"]; ?></td>
          </tr>
