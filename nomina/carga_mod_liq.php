...
}else{$error=1; echo $sql; ?> <script language="JavaScript"> muestra('CALCULO DE LIQUIDACION NO EXISTE');</script><?php } 
...
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txtfrec" type="hidden" id="txtfrec" value="<?php echo $frec?>"></td>
     <td width="5"><input name="txtultima_fecha" type="hidden" id="txtultima_fecha" value="<?php echo $ultima_fecha?>"></td>	 
     <td width="5"><input name="txtfecha_liquidacion" type="hidden" id="txtfecha_liquidacion" value="<?php echo $fecha_liquidacion?>" ></td>
	 <td width="5"><input name="txttipo_liquidacion" type="hidden" id="txttipo_liquidacion" value="<?php echo $tipo_liquidacion?>" ></td>
     <td width="5"><input name="txtant_ano" type="hidden" id="txtant_ano" value="<?php echo $ant_ano?>"></td>
     <td width="5"><input name="txtant_mes" type="hidden" id="txtant_mes" value="<?php echo $ant_mes?>"></td>
     <td width="5"><input name="txtant_dia" type="hidden" id="txtant_dia" value="<?php echo $ant_dia?>"></td>
     <td width="5"><input name="txtmonto_sue_int" type="hidden" id="txtmonto_sue_int" value="<?php echo $monto_sue_int?>"></td>
     <td width="5"><input name="txtsueldo_basico" type="hidden" id="txtsueldo_basico" value="<?php echo $sueldo_basico?>"></td>
	 <td width="5"><input name="txtmonto_cal_vac" type="hidden" id="txtmonto_cal_vac" value="<?php echo $monto_cal_vac?>"></td>
     <td width="5"><input name="txttiempo_servicio" type="hidden" id="txttiempo_servicio" value="<?php echo $tiempo_servicio?>"></td>
     <td width="5"><input name="txtmonto_garantia" type="hidden" id="txtmonto_garantia" value="<?php echo $monto_garantia?>"></td>
	 <td width="5"><input name="txtdias_dep" type="hidden" id="txtdias_dep" value="<?php echo $dias_dep?>"></td>
	 <td width="5"><input name="txtmonto_banco" type="hidden" id="txtmonto_banco" value="<?php echo $monto_banco?>"></td>
	 <td width="5"><input name="txtcampo_str1" type="hidden" id="txtcampo_str1" value="<?php echo $campo_str1?>"></td>
	 
	 <td width="5"><input name="txtmonto_art142" type="hidden" id="txtmonto_art142" value="<?php echo $monto_art142?>"></td>	
	 <td width="5"><input name="txtdias_art142" type="hidden" id="txtdias_art142" value="<?php echo $dias_art142?>"></td>	
	 ...
	 <td width="5"><input name="txtfecha_ant_depositada" type="hidden" id="txtfecha_ant_depositada" value="<?php echo $fecha_cal_garantia?>"></td>	 
	 <td width="5"><input name="txttotal_adelantos" type="hidden" id="txttotal_adelantos" value="<?php echo $total_adelantos?>"></td>
	 <td width="5"><input name="txttotal_intereses" type="hidden" id="txttotal_intereses" value="<?php echo $total_intereses?>"></td>
	 <td width="5"><input name="txtint_fraccionados" type="hidden" id="txtint_fraccionados" value="<?php echo $int_fraccionados?>"></td>
	 ...
	 <td width="5"><input name="txtdias_vacaciones_f" type="hidden" id="txtdias_vacaciones_f" value="<?php echo $dias_vacaciones_f?>"></td>
	 <td width="5"><input name="txtmonto_vacaciones_f" type="hidden" id="txtmonto_vacaciones_f" value="<?php echo $monto_vacaciones_f?>"></td>
	 <td width="5"><input name="txtdias_bono_vac_f" type="hidden" id="txtdias_bono_vac_f" value="<?php echo $dias_bono_vac_f?>"></td>
	 <td width="5"><input name="txtmonto_bono_vac_f" type="hidden" id="txtmonto_bono_vac_f" value="<?php echo $monto_bono_vac_f?>"></td>	 
	 <td width="5"><input name="txttotal_vacaciones_p" type="hidden" id="txttotal_vacaciones_p" value="<?php echo $total_vacaciones_p?>"></td>
	 <td width="5"><input name="txttotal_bono_vac_p" type="hidden" id="txttotal_bono_vac_p" value="<?php echo $total_bono_vac_p?>"></td>
	 <td width="5"><input name="txtdias_vac" type="hidden" id="txtdias_vac" value="<?php echo $dias_vac?>"></td>
	 <td width="5"><input name="txtdias_bono_vac" type="hidden" id="txtdias_bono_vac" value="<?php echo $dias_bono_vac?>"></td>	 
	 <td width="5"><input name="txtufecha_p" type="hidden" id="txtufecha_p" value="<?php echo $ufecha_p?>"></td>
	 <td width="5"><input name="txtfecha_caus_h" type="hidden" id="txtfecha_caus_h" value="<?php echo $fecha_caus_h?>"></td>	 
