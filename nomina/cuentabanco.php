...
$resultado=pg_query($StrSQL);$filas=pg_num_rows($resultado);if($filas>0){$registro=pg_fetch_array($resultado); $nro_cuenta=$registro["nro_cuenta"];} pg_close($conn);?>
<input name="txtcuenta_new" type="text" id="txtcuenta_new" size="30" maxlength="30" value="<?php echo $nro_cuenta?>" onFocus="encender(this)" onBlur="apagar(this)">
