...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="15" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="15" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
           <td width="99" align="right"><?php  echo $registro["tasa"]; ?></td>
           <td width="30" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
           <td width="9" align="right"><?php  echo $registro["tasa"]; ?></td>
		   </tr>
         <?php }
