...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Modificar('<?php  echo $registro["tipo_nomina"]; ?>','<?php  echo $registro["cod_concepto"]; ?>','<?php  echo $registro["cod_empleado"]; ?>');" >
           ...
           <td width="30" align="center"><?php  echo $registro["activoa"]; ?></td>
           <td width="100" align="right"><?php  echo $monto; ?></td>
           <td width="50" align="right"><?php  echo $nro_cuotas; ?></td>
           <td width="120" align="right"><?php  echo $monto_prestamo; ?></td>
           <td width="120" align="right"><?php  echo $acumulado; ?></td>
           <td width="120" align="right"><?php  echo $saldo; ?></td>
           <td width="50" align="right"><?php  echo $nro_cuotas_c; ?></td>
           <td width="100" align="center"><?php  echo formato_ddmmaaaa($registro["fecha_ini"]); ?></td>
           <td width="100" align="center"><?php  echo formato_ddmmaaaa($registro["fecha_exp"]); ?></td>
           <td width="170" align="center"><?php  echo $frecuencia; ?></td>
          </tr>
         <?php } ?>
       </table></td>
   </tr>
