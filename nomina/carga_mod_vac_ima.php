...
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txtmonto_bono_vac_a" type="hidden" id="txtmonto_bono_vac_a" value="<?php echo $monto_bono_vaca_a?>"></td>	
	 ...
	 <td width="5"><input name="txtcalcula_nomina" type="hidden" id="txtcalcula_nomina" value="<?php echo $calcula_nomina?>"></td>
