...
if (pg_last_error($conn)){ $error=1; $nomb_llama="erorr.php";  echo 'OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS',"<br>";} else{ $Nom_Emp=busca_conf(); }
...
*/ 
if($error==0){}?>
<iframe src="Calcula_nomina.php?criterio=<?php echo $criterio?>" width="950" height="350" scrolling="auto" frameborder="1"></iframe> 