<?php include ("../class/conect.php");  include ("../class/funciones.php"); $equipo=getenv("COMPUTERNAME");  $fecha_hoy=asigna_fecha_hoy();  $tipo_arch_banco='96';
...
function llamar_eliminar(){var murl; var r;
  ...
  if(r==true){r=confirm("Esta Realmente seguro en Eliminar campo del Archivo ?");
    if(r==true){murl="Delete_campo_arch_banco.php?cod_arch_banco=<?php echo $cod_arch_banco?>&pos_campo=<?php echo $pos_campo?>&tipo_arch_banco=<?php echo $tipo_arch_banco?>"; document.location=murl;}}  else{url="Cancelado, no elimino";}
}
function llamar_condicion(){var murl; var r;
  murl="Det_condicion_arch_banco.php?cod_arch_banco=<?php echo $cod_arch_banco?>&pos_campo=<?php echo $pos_campo?>&tipo_arch_banco=<?php echo $tipo_arch_banco?>"; document.location=murl;
}
        ...
        <tr>
          <td><table width="830" border="0">
              <tr>
                ...
                <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtcod_campo" type="text" id="txtcod_campo" size="3" maxlength="3" readonly value="<?php echo $cod_campo?>" > </span></td>
                <td width="100"><span class="Estilo5">DESCRIPCION:</span> </td>
                <td width="550"><span class="Estilo5">
                <?php  if($cod_campo=='999'){?>
                <input class="Estilo10" name="txtcar_especial" type="text" id="txtcar_especial" size="80" maxlength="80" onFocus="encender(this)" onBlur="apagar(this)"  value="<?php echo $car_especial?>">
                <?php }else{?>
                <input class="Estilo10" name="txtcar_especial" type="text" id="txtcar_especial" size="80" maxlength="80" readonly value="<?php echo $car_especial?>">
                <?php }?>
                </span></td>
              </tr>
          </table></td>
        ...
        <tr>
          <td><div id="dcarcampo"><table width="830" border="0">
              <tr>
                ...
                <td width="100"><span class="Estilo5"> <input class="Estilo10" name="txttipo_campo" type="text" id="txttipo_campo" size="1" maxlength="1" readonly value="<?php echo $tipo_campo?>" > </span></td>
                <td width="100"><span class="Estilo5">LONGITUD: </span></td>
                <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtlongitud_campo" type="text" id="txtlongitud_campo" size="3" maxlength="3" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $longitud_campo?>" > </span></td>
                <td width="100"><span class="Estilo5">DECIMALES: </span></td>
                <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtdecimales_campo" type="text" id="txtdecimales_campo" size="3" maxlength="3" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $decimales_campo?>"> </span></td>
                <td width="100"><span class="Estilo5">INICIO: </span></td>
                <td width="100"><span class="Estilo5"> <input class="Estilo10" name="txtpos_comienza" type="text" id="txtpos_comienza" size="3" maxlength="3" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $pos_comienza?>"> </span></td>
                <td width="40"><span class="Estilo5">FIN: </span></td>
                <td width="100"><span class="Estilo5"> <input class="Estilo10" name="txtpos_finaliza" type="text" id="txtpos_finaliza" size="3" maxlength="3" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $pos_finaliza?>"> </span></td>
               </tr>
           </table> </div></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
...
function asig_rellena_espacios_d(mvalor){var f=document.form1;  if(mvalor=="N"){document.form1.txtrellena_espacios_d.options[0].selected = true;}else{document.form1.txtrellena_espacios_d.options[1].selected = true;}}
        ...
        <tr><td>&nbsp;</td></tr>
<script language="JavaScript" type="text/JavaScript">
asig_rellena_ceros_izq('<?php echo $rellena_ceros_izq;?>'); asig_rellena_ceros_der('<?php echo $rellena_ceros_der;?>'); asig_rellena_espacios_i('<?php echo $rellena_espacios_i;?>'); asig_rellena_espacios_D('<?php echo $rellena_espacios_d;?>');
...
function asig_elimina_espacios_d(mvalor){var f=document.form1;  if(mvalor=="N"){document.form1.txtelimina_espacios_d.options[0].selected = true;}else{document.form1.txtelimina_espacios_d.options[1].selected = true;}}
        ...
        <tr><td>&nbsp;</td></tr>
<script language="JavaScript" type="text/JavaScript">
asig_elimina_ceros_izq('<?php echo $elimina_ceros_izq;?>'); asig_elimina_ceros_der('<?php echo $elimina_ceros_der;?>'); asig_elimina_espacios_i('<?php echo $elimina_espacios_i;?>'); asig_elimina_espacios_d('<?php echo $elimina_espacios_d;?>');
        ...
        <tr>
          <td><table width="830" border="0">
              <tr>
                ...
                <td width="70"><span class="Estilo5"><input class="Estilo10" name="txtpos_campo" type="text" id="txtpos_campo" size="3" maxlength="3" readonly value="<?php echo $pos_campo?>" > </span></td>
...
<script language="JavaScript" type="text/JavaScript"> asig_elimina_comas('<?php echo $elimina_comas;?>'); asig_elimina_puntos('<?php echo $elimina_puntos;?>'); asig_status2_campo('<?php echo $status2_campo;?>');  </script>
...
<script language="JavaScript" type="text/JavaScript"> 
var mcamb_punto_c='<?php echo $camb_punto_coma;?>';  
if(mcamb_punto_c=="N"){document.form1.txtstatus3_campo.options[0].selected=true;}else{document.form1.txtstatus3_campo.options[1].selected=true;}
        ...
        <table width="540" align="center">
          <tr>
            <td width="10"><input class="Estilo10" name="txtcod_arch_banco" type="hidden" id="txtcod_arch_banco" value="<?php echo $cod_arch_banco?>"></td>
            <td width="10"><input name="txttipo_arch_banco" type="hidden" id="txttipo_arch_banco" value="<?php echo $tipo_arch_banco?>"></td>
            <td width="20">&nbsp;</td>
