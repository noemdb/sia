<?php include ("../class/funciones.php"); if (!$_GET){$criterio='';$cod_estructura='';} else{$criterio=$_GET["criterio"];$cod_estructura=substr($criterio,0,8);}
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="93" align="left"><?php  echo $registro["tipo_ret"]; ?></td>
           <td width="175" align="left"><?php  echo $registro["descripcion_ret"]; ?></td>
           <td width="101" align="right"><?php  echo $registro["tasa"]; ?></td>
           <td width="127" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
           <td width="157" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="105" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="105" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="105" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="105" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="105" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="105" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
		   <td width="108" align="right"><?php  echo $registro["monto_objeto"]; ?></td>
         </tr>
         <?php }
