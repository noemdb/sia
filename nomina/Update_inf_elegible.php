...
if (pg_last_error($conn)){$error=1; ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?php }
 else{ if(checkData($fecha_nacimiento)=='1'){$error=0;} else{$error=1; ?> <script language="JavaScript">muestra('FECHA DE NACIMIENTO NO ES VALIDA');</script><?php } }
 if($error==0){if($nombre==""){$error=1; ?> <script language="JavaScript">muestra('NOMBRE NO ES VALIDO');</script><?php } }
 if($error==0){if($cedula==""){$error=1; ?> <script language="JavaScript">muestra('CEDULA NO ES VALIDA');</script><?php } }
 if($error==0){
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('CEDULA NO EXISTE EN INFORMACION DE ELEGIBLE');</script><?php }
