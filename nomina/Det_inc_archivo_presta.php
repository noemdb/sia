...
document.location='Inc_campo_arch_presta.php?cod_arch_banco=<?php echo $cod_arch_banco?>'+'&tipo_arch_banco=<?php echo $tipo_arch_banco?>'+'&pos_campo='+mpos_campo; }
function Llama_Modificar(mpos_campo){  if(mpos_campo==""){alert("Informacion debe ser Seleccionada");}
 else{document.location='Mod_campo_arch_presta.php?cod_arch_banco=<?php echo $cod_arch_banco?>'+'&tipo_arch_banco=<?php echo $tipo_arch_banco?>'+'&pos_campo='+mpos_campo;} }
</script>