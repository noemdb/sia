<?php include ("../class/conect.php"); include ("../class/funciones.php");  $tipo_nomina=$_GET["tipo_nomina"];$cod_concepto=$_GET["cod_concepto"];
...
$error=pg_errormessage($conn); $error="ERROR GRABANDO: ".substr($error, 0, 61); pg_close($conn);  ?>
