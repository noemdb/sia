...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="100" align="left"><?php  echo $registro["cod_rif_est"]; ?></td>
           ...
           <td width="200" align="center"><?php  echo $registro["cod_presup_est"]; ?></td>
           <td width="50" align="center"><?php  echo $registro["fuente_est"]; ?></td>
           <td width="140" align="center"><?php  echo $registro["ced_rif_ret"]; ?></td>
