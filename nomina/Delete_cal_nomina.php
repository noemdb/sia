<?php include ("../class/conect.php");  include ("../class/funciones.php");$tipo_nomina=$_GET["tipo_nomina"]; $tp_calculo=$_GET["tp_calculo"]; $url="Det_cal_nomina.php?criterio=".$tipo_nomina; echo "ESPERE POR FAVOR ELIMINANDO....","<br>";
