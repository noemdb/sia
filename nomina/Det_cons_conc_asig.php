...
<?php  while($registro=pg_fetch_array($res)){ $frec=$registro["frecuencia"]; $monto=formato_monto($registro["monto"]); $cantidad=formato_monto($registro["cantidad"]); $frecuencia="PRIMERA Y SEGUNDA QUINCENA";
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="60" align="left"><?php  echo $registro["cod_concepto"]; ?></td>
           <td width="300" align="left"><?php  echo $registro["denominacion"]; ?></td>
           <td width="40" align="center"><?php  echo $registro["activoa"]; ?></td>
           <td width="40" align="center"><?php  echo $registro["calculable"]; ?></td>
           <td width="170" align="left"><?php  echo $frecuencia; ?></td>
           <td width="90" align="right"><?php  echo $cantidad; ?></td>
