...
$temp_arch=basename( $_FILES['uploadedfile']['name']); ?><script language="JavaScript">muestra('CARGO EXITOSAMENTE');</script><?php 
} else{echo "Ha ocurrido un error, trate de nuevo!"; $temp_arch=""; ?><script language="JavaScript">muestra('ERROR AL CARGAR EL ARCHIVO ...');</script><?php 
} 
