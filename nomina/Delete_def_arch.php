<?php include ("../class/conect.php");  include ("../class/funciones.php");$cod_arch_banco=$_GET["txtcod_arch_banco"];   $tipo_arch_banco=$_GET["txttipo_arch_banco"];$fecha_hoy=asigna_fecha_hoy(); $sfechan=formato_aaaammdd($fecha_hoy);
