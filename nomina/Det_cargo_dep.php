 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Cargo al Departamento" onclick="javascript:LlamarURL('Inc_cargo_dep.php?codigo=<?php echo $codigo?>')"></td>
   ...
   <tr>
     <td>
<?php $sql="SELECT * from cargos_dep  where codigo_departamento='$codigo'";   $res=pg_query($sql);
?>
...
<?php  while($registro=pg_fetch_array($res)){  ?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Modificar('<?php  echo $codigo; ?>','<?php  echo $registro["codigo_cargo"]; ?>');">
           <td width="100" align="left"><?php  echo $registro["codigo_cargo"]; ?></td>
           <td width="240" align="left"><?php  echo $registro["denominacion"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["cod_tipo_personal"]; ?></td>
           <td width="210" align="left"><?php  echo $registro["des_tipo_personal"];  ?></td>
           <td width="90" align="left"><?php  echo $registro["nro_cargos"]; ?></td>
           </tr>
         <?php }?>
       </table></td>
   </tr>
