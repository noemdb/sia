...
if($error==0){?><script language="JavaScript">muestra('MODIFICO EXITOSAMENTE, CATIDAD: '+'<?php  echo $cant_mod; ?>'); document.location='<?php  echo $url; ?>';</script><?php }else{?><script language="JavaScript">history.back();</script><?php }?>
