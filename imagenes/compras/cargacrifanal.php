...
?><select name="txtced_rif" id="txtced_rif" onFocus="encender(this)" onBlur="apaga_crif(this);" class="Estilo5">  <?php 
...
if($codigo==$rif){?><option value="<?php  echo $nombre;?>" selected><?php  echo $codigo;?></option>
